...
export type CreateOperationData = FormCreateData<Omit<OpSchema, "refId" | "ref"> & ({
...
export type UpdateOperationData = FormUpdateData<Omit<OpSchema, "refId" | "ref">> & ({
...
export type FullAttr = NativeAttr | `mobiles$${number}.${Mobile.NativeAttr}` | `userRoles$${number}.${UserRole.NativeAttr}` | `userSystems$${number}.${UserSystem.NativeAttr}` | `tokens$user$${number}.${Token.NativeAttr}` | `tokens$player$${number}.${Token.NativeAttr}` | `users$${number}.${NativeAttr}` | `wechatUsers$${number}.${WechatUser.NativeAttr}` | `extraFiles$${number}.${ExtraFile.NativeAttr}`;
