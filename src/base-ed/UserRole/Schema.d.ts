...
export declare type CreateOperationData = FormCreateData<Omit<OpSchema, "userId" | "roleId" | "user" | "role"> & ({
...
export declare type UpdateOperationData = FormUpdateData<Omit<OpSchema, "userId" | "roleId" | "user" | "role">> & ({
