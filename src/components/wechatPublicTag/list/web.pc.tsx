...
export default function Render(
    ...
    const [tagInfo, setTagInfo] = useState({} as Partial<EntityDict['wechatPublicTag']['Schema']>);
                ...
                >
                    ...
                    >
                        ...
                        <Descriptions.Item label='状态'>
                            {tagInfo.iState === 'wait' ? '待同步' : tagInfo.iState === 'success' ? '同步成功' : '同步失败'}
                        </Descriptions.Item>
                        <Descriptions.Item label='同步时间'>
                            {tagInfo.syncAt ? dayjs(tagInfo.syncAt).format('YYYY-MM-DD HH:mm') : '--'}
                        </Descriptions.Item>
                            ...
                            render: (value, record, index) => {
                                return (
                                    <>
                                        ...
                                        {
                                            (!record.wechatId || ![0, 1, 2].includes(record.wechatId)) &&
                                            <Button
                                                type="link"
                                                onClick={() => {
                                                    setOpen(true);
