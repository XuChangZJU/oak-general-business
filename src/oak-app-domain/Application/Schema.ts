...
type AttrFilter = {
    ...
    wechatTemplate$application: WechatTemplate.Filter & SubQueryPredicateMetadata;
...
export type CreateOperationData = FormCreateData<Omit<OpSchema, "systemId">> & (({
    ...
    wechatTemplate$application?: OakOperation<WechatTemplate.UpdateOperation["action"], Omit<WechatTemplate.UpdateOperationData, "application" | "applicationId">, Omit<WechatTemplate.Filter, "application" | "applicationId">> | OakOperation<"create", Omit<WechatTemplate.CreateOperationData, "application" | "applicationId">[]> | Array<OakOperation<"create", Omit<WechatTemplate.CreateOperationData, "application" | "applicationId">> | OakOperation<WechatTemplate.UpdateOperation["action"], Omit<WechatTemplate.UpdateOperationData, "application" | "applicationId">, Omit<WechatTemplate.Filter, "application" | "applicationId">>>;
...
export type UpdateOperationData = FormUpdateData<Omit<OpSchema, "systemId">> & (({
    ...
    wechatTemplate$application?: OakOperation<WechatTemplate.UpdateOperation["action"], Omit<WechatTemplate.UpdateOperationData, "application" | "applicationId">, Omit<WechatTemplate.Filter, "application" | "applicationId">> | OakOperation<WechatTemplate.RemoveOperation["action"], Omit<WechatTemplate.RemoveOperationData, "application" | "applicationId">, Omit<WechatTemplate.Filter, "application" | "applicationId">> | OakOperation<"create", Omit<WechatTemplate.CreateOperationData, "application" | "applicationId">[]> | Array<OakOperation<"create", Omit<WechatTemplate.CreateOperationData, "application" | "applicationId">> | OakOperation<WechatTemplate.UpdateOperation["action"], Omit<WechatTemplate.UpdateOperationData, "application" | "applicationId">, Omit<WechatTemplate.Filter, "application" | "applicationId">> | OakOperation<WechatTemplate.RemoveOperation["action"], Omit<WechatTemplate.RemoveOperationData, "application" | "applicationId">, Omit<WechatTemplate.Filter, "application" | "applicationId">>>;
