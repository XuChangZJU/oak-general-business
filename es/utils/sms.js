import { SmsSdk } from 'oak-external-sdk';
...
export async function sendSms(options, context) {
    ...
    if (origin === 'tencent') {
        for (const smsConfig of smsConfigs) {
            ...
            const SmsSdkInstance = SmsSdk.getInstance(origin, accountConfig.secretId, accountConfig.secretKey, accountConfig.region, accountConfig.endpoint);
