...
export default function Render(props) {
    ...
    return (_jsx(PageHeader, { title: "\u5730\u94C1\u7EBF\u8DEF\u7BA1\u7406", children: _jsxs("div", { className: Style.container, children: [_jsxs("div", { children: ["\u70B9\u51FB\u5207\u6362\u57CE\u5E02\uFF1A", _jsx(Select, { placeholder: '切换城市', value: areaId, onChange: (value) => {
                                setAreaId(value);
