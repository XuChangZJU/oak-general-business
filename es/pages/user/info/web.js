...
export default function render(props) {
    ...
    return (_jsxs("div", { className: Style.container, children: [_jsxs(List, { className: Style.list, children: [_jsx(List.Item, { extra: _jsx(OakAvatar, { oakAutoUnmount: true, oakPath: oakFullpath
