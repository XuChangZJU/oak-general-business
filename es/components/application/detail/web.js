    ...
    if (id && oakFullpath) {
        return (_jsxs(_Fragment, { children: [_jsx(Modal, { open: open, width: 800, onCancel: () => {
                        ...
                        setOpen(false);
                            ...
                            await execute();
                            setOpen(false);
                        }, disabled: oakExecutable !== true || oakExecuting, children: t('common::action.confirm') }), children: _jsx(ApplicationUpsert, { oakPath: oakFullpath, oakId: id }) }), _jsxs(Descriptions, { column: 2, bordered: true, children: [_jsx(Descriptions.Item, { label: "id", children: _jsx(Typography.Paragraph, { copyable: true, children: id }) }), _jsx(Descriptions.Item, { label: t('application:attr.name'), children: name }), _jsx(Descriptions.Item, { label: t('application:attr.description'), children: description }), _jsx(Descriptions.Item, { label: t('application:attr.type'), children: t(`application:v.type.${type}`) }), _jsx(Descriptions.Item, { children: _jsx(Row, { children: _jsx(Button, { type: "primary", onClick: () => setOpen(true), children: t('common::action.update') }) }) })] })] }));
    }
}
