        ...
        if (!show) {
            ...
            if (allowCreateSubArticle) {
                items.push({
                    ...
                    label: (<div className={Styles.addAction} onClick={() => {
                            modal.confirm({
                                title: '输入文章标题',
                                cancelText: '取消',
                                okText: '提交',
                                content: (<Input ref={subArticleNameRef}/>),
                                onOk: async () => {
                ...
                items.push({
                    ...
                    label: (<div className={Styles.addAction} onClick={() => {
                            modal.confirm({
                                ...
                                cancelText: '取消',
                                okText: '提交',
                                content: (<Input ref={subMenuNameRef}/>),
                                onOk: async () => {
                        ...
                        const modalInstance = modal.confirm({
                            ...
                            content: (<div>
                                                        ...
                                                        <Form.Item label="LOGO" help={<div>
                                                            ...
                                                            <>
                                                                <ExtraFileUpload oakPath={oakFullpath
                            ...
                            // }
                            footer: <Space>
                                                    <ExtraFileCommit oakPath={oakFullpath} afterCommit={() => {
                ...
                return (<>
                    ...
                    {contextHolder} */}
                        ...
                        setNewBreadcrumbItems([...breadItems, row?.name]);
                            ...
                            <div className={Styles.ne}>
                                <div className={Styles.name}>
                                    {logo ? (<Image height={26} width={26} src={logo} preview={false} style={{ marginRight: 4 }}/>) : null}
                                    <div>{row?.name}</div>
                                </div>
                            </div>
                            <div className={Styles.control}>
                        ...
                        <div className={Styles.leftArrow}></div>) : <div className={Styles.ph}/>}
                            </div>
                        </div>
                        {showSub && (<div className={Styles.sub3} style={{ background: '#f5f5f5' }}>
                                    {Sub}
                                </div>)}
                        {contextHolder}
                    </>);
