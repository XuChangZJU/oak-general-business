            ...
            <Tabs tabPosition={'top'} size={'middle'} type="card" items={[
            {
                ...
                children: (<Form colon={true} labelAlign="left" layout="vertical" style={{ marginTop: 10 }}>
                                <Form.Item label="accessKey">
                                    <>
                                        <Input placeholder="请输入accessKey" type="text" value={live?.accessKey} onChange={(e) => setValue(`accessKey`, e.target.value)}/>
                                    </>
                                </Form.Item>
                                <Form.Item label="hub">
                                    <>
                                        <Input placeholder="请输入hub" type="text" value={live?.hub} onChange={(e) => setValue(`hub`, e.target.value)}/>
                                    </>
                                </Form.Item>
                                <Form.Item label="liveHost">
                                    <>
                                ...
                                <Form.Item label="playBackDomain">
                                    <>
...
export default function Cos(props) {
    ...
    return (<Space direction="vertical" size="middle" style={{ display: 'flex' }}>
            ...
            <Qiniu live={qiniu} setValue={(path, value) => setValue(`qiniu.${path}`, value)}/>
        </Space>);
}
