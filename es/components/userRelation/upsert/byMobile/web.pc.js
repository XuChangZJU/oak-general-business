...
export default function Render(props) {
    ...
    rules={[
            ...
            {mobileValueReady && userId && (<OnUser oakAutoUnmount={true} oakPath={`${oakFullpath}.user`} entity={entity} entityId={entityId} relations={relations} oakId={userId} setPasswordConfirm={setPasswordConfirm}/>)}
            <Form colon labelCol={{ span: 4 }} wrapperCol={{ span: 8 }}>
