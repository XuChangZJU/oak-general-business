...
export declare function tryMakeSmsNotification(message: EntityDict['message']['Schema'], context: BackendRuntimeContext<EntityDict>): Promise<Omit<import("../oak-app-domain/Notification/Schema").CreateOperationData, "messageSystemId"> | undefined>;
