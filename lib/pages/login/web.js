...
function render() {
    var _this = this;
    var _a = this.props, onlyCaptcha = _a.onlyCaptcha, onlyPassword = _a.onlyPassword;
    var _b = this.state, mobile = _b.mobile, captcha = _b.captcha, password = _b.password, counter = _b.counter, loginMode = _b.loginMode, loading = _b.loading, loginAgreed = _b.loginAgreed, appId = _b.appId;
    ...
    var LoginCaptcha = ((0, jsx_runtime_1.jsxs)(antd_1.Form, tslib_1.__assign({ colon: true }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, tslib_1.__assign({ name: "mobile" }, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { allowClear: true, value: mobile, type: "tel", size: "large", maxLength: 11, prefix: (0, jsx_runtime_1.jsx)(icons_1.MobileOutlined, {}), placeholder: this.t('placeholder.Mobile'), onChange: function (e) {
                    ...
                    }, className: web_module_less_1.default['loginbox-input'] }) })), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, tslib_1.__assign({ name: "captcha" }, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { allowClear: true, value: captcha, size: "large", maxLength: 4, placeholder: this.t('placeholder.Captcha'), onChange: function (e) {
                        _this.setState({
                            captcha: e.target.value,
                        });
                    }, className: web_module_less_1.default['loginbox-input'], suffix: (0, jsx_runtime_1.jsx)(antd_1.Button, tslib_1.__assign({ size: "small", type: "link", disabled: !validMobile || counter > 0, onClick: function () { return _this.sendCaptcha(); } }, { children: counter > 0
                            ? "".concat(counter, "\u79D2\u540E\u53EF\u91CD\u53D1")
                            : this.t('Send') })) }) })), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { children: (0, jsx_runtime_1.jsx)(antd_1.Button, tslib_1.__assign({ block: true, size: "large", type: "primary", disabled: !allowSubmit || loading, loading: loading, onClick: function () { return _this.loginByMobile(); } }, { children: this.t('Login') })) })] })));
    if (onlyCaptcha) {
