...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(Container, tslib_1.__assign({ showBack: showBack, variant: variant }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Space, { children: (0, jsx_runtime_1.jsx)(antd_1.Button, tslib_1.__assign({ type: "primary", onClick: function () {
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        render: function (value, record, index) {
                            return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(actionBtnPanel_1.default, { mode: "table-cell", entity: "system", oakAutoUnmount: true, oakId: record.id, oakPath: "".concat(oakFullpath, ".").concat(record.id), items: [
                                        {
                                            label: '详情',
                                            onClick: function () {
                                                goDetail(record.id);
