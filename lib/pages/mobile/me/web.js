...
function render() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: "page-body" }, { children: [(0, jsx_runtime_1.jsx)(tdesign_mobile_react_1.CellGroup, { children: mobiles === null || mobiles === void 0 ? void 0 : mobiles.map(function (ele, index) { return ((0, jsx_runtime_1.jsx)(tdesign_mobile_react_1.Cell, { title: ele.mobile, onClick: function () {
                        _this.setState({
