...
function render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: mobile_module_less_1.default.container, children: [mobiles && mobiles.length > 0 ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_mobile_1.List, { className: mobile_module_less_1.default.list, children: mobiles === null || mobiles === void 0 ? void 0 : mobiles.map(function (ele, index) { return ((0, jsx_runtime_1.jsx)(antd_mobile_1.List.Item, { prefix: (0, jsx_runtime_1.jsx)(icons_1.MobileOutlined, {}), extra: allowRemove && tokenMobileId !== ele.id && ((0, jsx_runtime_1.jsx)("div", { onClick: function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                ...
                                }); }, children: (0, jsx_runtime_1.jsx)(icons_1.DeleteOutlined, {}) })), children: ele.mobile }, index)); }) }), (0, jsx_runtime_1.jsx)("div", { style: { flex: 1 } })] })) : ((0, jsx_runtime_1.jsx)("div", { className: mobile_module_less_1.default.noData, children: (0, jsx_runtime_1.jsx)("span", { children: "\u5C1A\u672A\u7ED1\u5B9A\u624B\u673A\u53F7" }) })), (0, jsx_runtime_1.jsx)(antd_mobile_1.Button, { block: true, size: "large", color: "primary", onClick: function () { return goAddMobile(); }, children: "\u7ED1\u5B9A" })] }));
}
