...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(Container, { variant: variant, children: [(0, jsx_runtime_1.jsx)(antd_1.Space, { style: { marginBottom: 16 }, children: (0, jsx_runtime_1.jsx)(antd_1.Button, { type: "primary", onClick: function () {
                        goCreate();
                    ...
                    // },
                    {
                        ...
                        render: function (value, record, index) {
                            return ((0, jsx_runtime_1.jsx)(antd_1.Typography.Link, { onClick: function () {
                                    goDetail(record.id);
                                }, children: value }));
                        },
                    },
                    ...
                    },
                    {
                        ...
                        render: function (value, record, index) {
                            return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_1.Button, { type: "link", onClick: function () {
                                            ...
                                            goUpdate(record.id);
                                        }, children: "\u66F4\u65B0" }), (0, jsx_runtime_1.jsx)(antd_1.Button, { type: "link", onClick: function () {
                                            remove(record.id);
                                        }, children: "\u5220\u9664" })] }));
                        },
                        fixed: 'right',
