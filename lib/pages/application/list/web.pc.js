...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(Container, tslib_1.__assign({ variant: variant }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Space, { children: (0, jsx_runtime_1.jsx)(antd_1.Button, tslib_1.__assign({ type: "primary", onClick: function () {
                    ...
                    },
                    {
                        ...
                        render: function (value, record, index) {
                            var _a, _b;
                            return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(actionBtnPanel_1.default, { mode: "table-cell", entity: "application", oakAutoUnmount: true, items: [
                                        {
                                            label: '详情',
                                            onClick: function () {
                                                goDetail(record.id);
