...
function Render(props) {
    ...
    if (type === 'wechatPublic') {
        Actions.push((0, jsx_runtime_1.jsx)(antd_1.Button, { onClick: function () { return goWechatPublicTagList(); }, children: "\u516C\u4F17\u53F7Tag\u7BA1\u7406" }));
    }
    var items = [
        {
            label: '应用概览',
            key: 'detail',
            children: ((0, jsx_runtime_1.jsxs)(antd_1.Descriptions, { column: 1, bordered: true, children: [(0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, { label: "id", children: (0, jsx_runtime_1.jsx)(antd_1.Typography.Paragraph, { copyable: true, children: oakId }) }), (0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, { label: t('application:attr.name'), children: name }), (0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, { label: t('application:attr.description'), children: description }), (0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, { label: t('application:attr.type'), children: t("application:v.type.".concat(type)) }), (0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, { label: t('application:attr.system') +
