    ...
    methods: {
        login: function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var features, token, url, startStr, endStr, urlObj, query, code, state, err_1;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!(process.env.NODE_ENV === 'production' && token)) return [3 /*break*/, 2];
                            //token有效 不调用登录
                            console.log('token有效');
                            this.setState({
                                loading: false,
        ...
        go: function (state) {
            ...
            var stateObj = url_1.default.parse(decodeURIComponent(state), true);
