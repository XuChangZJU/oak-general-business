...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(pageHeader_1.default, tslib_1.__assign({ title: "\u5FAE\u4FE1\u516C\u4F17\u53F7\u6807\u7B7E", showBack: showBack }, { children: (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: web_module_less_1.default.container }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Space, { children: (0, jsx_runtime_1.jsx)(antd_1.Button, tslib_1.__assign({ type: "primary", onClick: function () {
                        ...
                        {
                            dataIndex: 'text',
                            title: t('wechatPublic:attr.text'),
                            width: 200,
                            ellipsis: true,
                        },
                        {
                            dataIndex: 'wechatId',
                            title: t('wechatPublic:attr.wechatId'),
                            width: 100,
                        },
                        {
                            dataIndex: 'sync',
                            title: t('wechatPublic:attr.sync'),
                            width: 100,
                        ...
                        {
                            dataIndex: 'syncAt',
                            title: t('wechatPublic:attr.syncAt'),
                            width: 100,
                            render: function (value, record, index) {
