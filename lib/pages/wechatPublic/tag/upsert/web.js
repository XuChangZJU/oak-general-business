...
function Render(props) {
    ...
    var TagOptions = Object.keys(constants_1.WechatPublicTags).map(function (ele) { return ({
        label: ele,
        value: constants_1.WechatPublicTags[ele],
    }); });
    return ((0, jsx_runtime_1.jsx)(pageHeader_1.default, tslib_1.__assign({ showBack: true, title: "\u5FAE\u4FE1\u516C\u4F17\u53F7TAG\u4FE1\u606F" }, { children: (0, jsx_runtime_1.jsx)(antd_1.Row, { children: (0, jsx_runtime_1.jsx)(antd_1.Col, tslib_1.__assign({ xs: 24, sm: 12 }, { children: (0, jsx_runtime_1.jsxs)(antd_1.Form, tslib_1.__assign({ colon: true, labelCol: { span: 6 }, wrapperCol: { span: 16 } }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, tslib_1.__assign({ label: "TAG\u540D\u79F0", requiredMark: true, name: "text", rules: [
                                {
                                    required: true,
                                },
