...
var utils_1 = require("oak-frontend-base/es/utils/utils");
...
function Render(props) {
    ...
    granteeId = _a.granteeId, number = _a.number, confirmed = _a.confirmed, userId = _a.userId, redirectTo = _a.redirectTo, redirectCounter = _a.redirectCounter, id = _a.id, oakId = _a.oakId;
    ...
    var getRelationTip = function () {
        ...
        var relationStr = (relation === null || relation === void 0 ? void 0 : relation.display) || relation
            ? t("".concat(entity, ":r.").concat(relation === null || relation === void 0 ? void 0 : relation.name))
            : '';
        if (type === 'grant') {
    ...
    if (oakLoading) {
        return ((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_module_less_1.default.container }, { children: (0, jsx_runtime_1.jsx)(success_1.default, { icon: (0, jsx_runtime_1.jsx)(icons_1.LoadingOutlined, { className: web_module_less_1.default.brand_icon }), title: "\u52A0\u8F7D\u4E2D", description: "\u6B63\u5728\u83B7\u53D6\u6570\u636E\uFF0C\u8BF7\u7A0D\u540E" }) })));
    }
    if (oakId !== id) {
        return ((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_module_less_1.default.container }, { children: (0, jsx_runtime_1.jsx)(fail_1.default, { title: "\u6570\u636E\u975E\u6CD5", description: "\u62B1\u6B49\uFF0C\u8BE5\u6570\u636E\u4E0D\u5B58\u5728" }) })));
    }
