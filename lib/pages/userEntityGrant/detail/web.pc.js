...
function Render(props) {
    var _a = props.data, variant = _a.variant, _b = _a.showBack, showBack = _b === void 0 ? true : _b, url = _a.url, expiresAt = _a.expiresAt, _c = _a.title, title = _c === void 0 ? '授权二维码' : _c;
    return ((0, jsx_runtime_1.jsx)(Container, tslib_1.__assign({ showBack: showBack, variant: variant, title: title }, { children: (0, jsx_runtime_1.jsx)(qrCode_1.default, { url: url, expiresAt: expiresAt }) })));
}
