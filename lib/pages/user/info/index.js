...
exports.default = OakComponent({
    ...
    formData: function (_a) {
        ...
        var isRoot = features.token.isReallyRoot();
        return {
    ...
    methods: {
        ...
        unbindingWechat: function (captcha) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a, mobile, wechatUser, err_3;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this.state, mobile = _a.mobile, wechatUser = _a.wechatUser;
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.features.cache.exec('unbindingWechat', {
