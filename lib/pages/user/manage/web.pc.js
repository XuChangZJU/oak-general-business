...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(pageHeader_1.default, { children: (0, jsx_runtime_1.jsxs)("div", { className: web_module_less_1.default.container, children: [isRoot && ((0, jsx_runtime_1.jsx)(antd_1.Space, { style: { marginBottom: 16 }, children: (0, jsx_runtime_1.jsx)(antd_1.Button, { type: "primary", onClick: function () {
                            goNewUser();
                        ...
                        },
                        {
                            ...
                            title: '状态',
                            render: function (value, record, index) {
                                return ((0, jsx_runtime_1.jsx)(antd_1.Tag, { color: stateColor[value], children: t("user:v.userState.".concat(value)) }));
                            },
                        },
                        {
                            dataIndex: 'op',
                            ...
                            align: 'center',
                            render: function (value, record, index) {
                                return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Button, { type: "link", onClick: function () {
