...
function Render(props) {
    ...
    var execute = methods.execute, t = methods.t, update = methods.update, setDisablePulldownRefresh = methods.setDisablePulldownRefresh;
    ...
    return ((0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: web_module_less_1.default.container }, { children: [(0, jsx_runtime_1.jsxs)(antd_mobile_1.Form, tslib_1.__assign({ layout: "horizontal" }, { children: [(0, jsx_runtime_1.jsx)(antd_mobile_1.Form.Item, tslib_1.__assign({ label: t('user:attr.nickname') }, { children: (0, jsx_runtime_1.jsx)(antd_mobile_1.Input, { onChange: function (val) { return update({ nickname: val }); }, value: data.nickname || '' }) })), (0, jsx_runtime_1.jsx)(antd_mobile_1.Form.Item, tslib_1.__assign({ label: t('user:attr.name') }, { children: (0, jsx_runtime_1.jsx)(antd_mobile_1.Input, { onChange: function (val) { return update({ name: val }); }, value: data.name || '' }) })), (0, jsx_runtime_1.jsx)(antd_mobile_1.Form.Item, tslib_1.__assign({ label: t('user:attr.birth'), onClick: function () {
                            ...
                            setDisablePulldownRefresh(true);
                                ...
                                update({ gender: e });
                            }, value: data.gender }, { children: (0, jsx_runtime_1.jsx)(antd_mobile_1.Space, tslib_1.__assign({ direction: "horizontal" }, { children: GenderOptions.map(function (ele, idx) { return (0, jsx_runtime_1.jsx)(antd_mobile_1.Radio, tslib_1.__assign({ value: ele.value, className: web_module_less_1.default.radio }, { children: ele.label }), idx); }) })) })) })), (0, jsx_runtime_1.jsx)(antd_mobile_1.Form.Item, tslib_1.__assign({ label: t('user:attr.idCardType') }, { children: (0, jsx_runtime_1.jsx)(antd_mobile_1.Radio.Group, tslib_1.__assign({ onChange: function (e) {
                                update({ idCardType: e });
                            }, value: data.idCardType }, { children: (0, jsx_runtime_1.jsx)(antd_mobile_1.Space, tslib_1.__assign({ direction: "vertical" }, { children: IDCardTypeOptions.map(function (ele, idx) { return (0, jsx_runtime_1.jsx)(antd_mobile_1.Radio, tslib_1.__assign({ value: ele.value, className: web_module_less_1.default.radio }, { children: ele.label }), idx); }) })) })) })), (0, jsx_runtime_1.jsx)(antd_mobile_1.Form.Item, tslib_1.__assign({ label: t('user:attr.idNumber') }, { children: (0, jsx_runtime_1.jsx)(antd_mobile_1.Input, { onChange: function (val) { return update({ idNumber: val }); }, value: data.idNumber || '' }) }))] })), (0, jsx_runtime_1.jsx)(antd_mobile_1.DatePicker, { visible: birthPickerVisible, max: new Date(), min: new Date('1900-01-01'), onConfirm: function (value) {
                    var val = value.valueOf();
                    update({ birth: val });
                }, onClose: function () {
                    setBirthPickerVisible(false);
                    setDisablePulldownRefresh(false);
                } }), (0, jsx_runtime_1.jsx)("div", { style: { flex: 1 } }), (0, jsx_runtime_1.jsx)(antd_mobile_1.Button, tslib_1.__assign({ block: true, color: "primary", onClick: function () { return execute(); } }, { children: t('common::action.confirm') }))] })));
}
