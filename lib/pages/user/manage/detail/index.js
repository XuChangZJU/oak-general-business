...
exports.default = OakComponent({
    ...
    formData: function (_a) {
        var _b;
        var user = _a.data, features = _a.features, legalActions = _a.legalActions;
        ...
        var reallyRoot = features.token.isReallyRoot();
        var currentUserId = features.token.getUserId();
        var executableActions = (reallyRoot && currentUserId !== id) ? legalActions.concat('play') : legalActions;
        return {
            id: id,
            nickname: nickname,
            name: name,
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            id = this.state.id;
                            return [4 /*yield*/, this.features.token.switchTo(id)];
                        case 5:
                            _b.sent();
                            return [3 /*break*/, 7];
                        case 6:
