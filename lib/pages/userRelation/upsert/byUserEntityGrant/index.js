...
exports.default = OakComponent({
    ...
    methods: {
        onShareAppMessage: function (e) {
            ...
            var config = app.config, systemConfig = app.system.config;
            var userEntityGrantId = this.state.userEntityGrantId;
            var imageUrl = config && ((_a = config.App) === null || _a === void 0 ? void 0 : _a.mpShareImageUrl) || systemConfig && ((_b = systemConfig === null || systemConfig === void 0 ? void 0 : systemConfig.App) === null || _b === void 0 ? void 0 : _b.mpShareImageUrl) || '';
        ...
        setInit: function () {
            var _a = this.props, entity = _a.entity, entityId = _a.entityId, type = _a.type, redirectToAfterConfirm = _a.redirectToAfterConfirm;
            this.update({
                entity: entity,
                entityId: entityId,
                type: type || 'grant',
