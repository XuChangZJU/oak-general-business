...
exports.default = OakComponent({
    ...
    filters: [
        {
            filter: function () {
                var _a;
                var _b = this.props, entityId = _b.entityId, entity = _b.entity;
                var relationss = this.state.relationss;
    ...
    methods: {
        calcRelations: function () {
            ...
            var relationss = legalRelations ? (relations ? relations.filter(function (ele) { return legalRelations.includes(ele); }) : legalRelations) : [];
            this.setState({
