...
exports.default = OakComponent({
    ...
    projection: function () {
        var _a, _b, _c;
        var _d = this.props, entity = _d.entity, entityId = _d.entityId;
    ...
    filters: [
        {
            filter: function () {
                var _a;
                var _b = this.props, entityId = _b.entityId, entity = _b.entity, relations = _b.relations;
    ...
    methods: {
        goUpsert: function () {
            var _a = this.props, entity = _a.entity, entityId = _a.entityId, relations = _a.relations, redirectToAfterConfirm = _a.redirectToAfterConfirm, qrCodeType = _a.qrCodeType;
            this.navigateTo({
