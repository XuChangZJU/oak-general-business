...
function render() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: mobile_module_less_1.default.container }, { children: [(0, jsx_runtime_1.jsx)(tdesign_react_1.List, { children: users === null || users === void 0 ? void 0 : users.map(function (ele, index) {
                    var _a;
                    return ((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ onClick: function (e) { return _this.goDetail(ele.id); } }, { children: (0, jsx_runtime_1.jsx)(ListItem, { children: (0, jsx_runtime_1.jsx)(ListItemMeta, { image: ele.avatar ? ((0, jsx_runtime_1.jsx)(tdesign_react_1.Avatar, { className: mobile_module_less_1.default.avatar, image: ele.avatar })) : ((0, jsx_runtime_1.jsx)(tdesign_react_1.Avatar, tslib_1.__assign({ className: mobile_module_less_1.default.avatar }, { children: (0, jsx_runtime_1.jsx)("span", tslib_1.__assign({ className: mobile_module_less_1.default.text }, { children: (0, randomUser_1.getName)(ele.name) })) }))), title: (0, jsx_runtime_1.jsx)("div", { children: ele.name || '--' }), description: (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: mobile_module_less_1.default.description }, { children: [(0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: mobile_module_less_1.default.row }, { children: [(0, jsx_runtime_1.jsx)("span", tslib_1.__assign({ className: mobile_module_less_1.default.label }, { children: "\u6635\u79F0:\u00A0" })), (0, jsx_runtime_1.jsx)("span", tslib_1.__assign({ className: mobile_module_less_1.default.value }, { children: ele.nickname || '--' }))] })), (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: mobile_module_less_1.default.row }, { children: [(0, jsx_runtime_1.jsx)("span", tslib_1.__assign({ className: mobile_module_less_1.default.label }, { children: "\u624B\u673A\u53F7:\u00A0" })), (0, jsx_runtime_1.jsx)("span", tslib_1.__assign({ className: mobile_module_less_1.default.value }, { children: ele.mobile || '--' }))] })), (0, jsx_runtime_1.jsx)(tdesign_react_1.Space, { children: (_a = ele.relations) === null || _a === void 0 ? void 0 : _a.map(function (relation, index) { return ((0, jsx_runtime_1.jsx)(tdesign_react_1.Tag, tslib_1.__assign({ variant: "outline", theme: "primary", className: "", style: {} }, { children: t("".concat(entity, ":r.").concat(relation)) }), index)); }) })] })) }) }) }), index));
                }) }), (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: mobile_module_less_1.default.fab }, { children: (0, jsx_runtime_1.jsx)(tdesign_react_1.Button, { size: "large", shape: "circle", icon: (0, jsx_runtime_1.jsx)(tdesign_icons_react_1.Icon, { name: "add" }), onClick: function () {
                        _this.goUpsert();
                    } }) }))] })));
}
