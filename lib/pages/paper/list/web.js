...
function render(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(pageHeader_1.default, { title: title || '文章管理', showBack: showBack, children: (0, jsx_runtime_1.jsxs)("div", { className: web_module_less_1.default.container, children: [(0, jsx_runtime_1.jsxs)(antd_1.Row, { children: [(0, jsx_runtime_1.jsx)(antd_1.Col, { flex: "auto", children: (0, jsx_runtime_1.jsx)(antd_1.Space, { children: (0, jsx_runtime_1.jsx)(antd_1.Button, { type: "primary", onClick: function () {
                                        goUpsert();
                                    }, children: t('action.add') }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Col, { flex: "none", children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165\u6807\u9898", value: searchValue, allowClear: true, onChange: function (e) {
                        ...
                        },
                        {
                            ...
                            render: function (value, record, index) {
                                return ((0, jsx_runtime_1.jsx)(antd_1.Tag, { color: "processing", children: t("book:v.iState.".concat(value)) }));
                            },
                        },
                        {
                            dataIndex: 'title',
                        ...
                        },
                        {
                            ...
                            align: 'center',
                            render: function (value, record, index) {
                                return ((0, jsx_runtime_1.jsxs)(antd_1.Space, { children: [(0, jsx_runtime_1.jsx)(antd_1.Button, { type: "link", onClick: function () {
