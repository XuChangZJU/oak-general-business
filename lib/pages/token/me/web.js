...
function Render(props) {
    ...
    var _b = props.methods, doLogin = _b.doLogin, t = _b.t, goMyMobile = _b.goMyMobile, goUserManage = _b.goUserManage, clean = _b.clean, execute = _b.execute, updateItem = _b.updateItem, goMyInfo = _b.goMyInfo;
