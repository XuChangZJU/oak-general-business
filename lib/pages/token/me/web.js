...
function Render(props) {
    var _this = this;
    var _a = props.data, avatar = _a.avatar, isLoggedIn = _a.isLoggedIn, refreshing = _a.refreshing, mobile = _a.mobile, mobileCount = _a.mobileCount, isRoot = _a.isRoot, oakExecuting = _a.oakExecuting, tokenId = _a.tokenId, nickname = _a.nickname, oakDirty = _a.oakDirty;
