...
exports.default = OakComponent({
    ...
    filters: [{
            filter: function (_a) {
                ...
                var tokenId = features.token.getTokenValue();
                if (tokenId) {
                    return {
                        id: tokenId,
                    };
    ...
    formData: function (_a) {
        var _b, _c;
        var _d = tslib_1.__read(_a.data, 1), token = _d[0];
        ...
        var avatar = avatarFile && (0, extraFile_1.composeFileUrl)(avatarFile);
        ...
        var isRoot = (player === null || player === void 0 ? void 0 : player.userRole$user) &&
            ((_c = player.userRole$user[0]) === null || _c === void 0 ? void 0 : _c.roleId) === constants_1.ROOT_ROLE_ID;
        return {
