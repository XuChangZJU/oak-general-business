...
function render(props) {
    ...
    var _b = props.methods, t = _b.t, gotoUpsertById = _b.gotoUpsertById, gotoArticleUpsert = _b.gotoArticleUpsert, gotoEdit = _b.gotoEdit, loadArticles = _b.loadArticles, gotoDoc = _b.gotoDoc;
