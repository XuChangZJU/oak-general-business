...
function render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: mobile_module_less_1.default.container, children: [(0, jsx_runtime_1.jsx)(antd_mobile_1.List, { className: mobile_module_less_1.default.list, children: LIST_BTN.map(function (ele) {
                    return ((0, jsx_runtime_1.jsx)(antd_mobile_1.List.Item, { arrow: true, onClick: function () {
                            setVisible();
                        }, children: ele.label }));
