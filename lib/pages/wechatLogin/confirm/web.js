...
function Render(props) {
    ...
    // }
    if (type === 'bind') {
        V = ((0, jsx_runtime_1.jsxs)(antd_1.Space, { direction: "vertical", align: 'center', size: 16, children: [(0, jsx_runtime_1.jsx)(Text, { type: "success", style: { color: 'var(--oak-color-primary)' }, children: "\u60A8\u5C1A\u672A\u7ED1\u5B9A\u5FAE\u4FE1\uFF0C\u7ED1\u5B9A\u767B\u5F55\u66F4\u4FBF\u6377" }), (0, jsx_runtime_1.jsx)(Text, { type: "secondary", children: "\u70B9\u51FB\u4E0B\u65B9\u6309\u94AE\u7ED1\u5B9A\u60A8\u7684\u5FAE\u4FE1\u8D26\u53F7" }), (0, jsx_runtime_1.jsx)(antd_1.Button, { disabled: oakExecuting || oakLoading, type: "primary", shape: "round", icon: (0, jsx_runtime_1.jsx)(icons_1.WechatOutlined, {}), size: "large", onClick: () => getCodeAndRedirect(), children: "\u7ED1\u5B9A\u5FAE\u4FE1" })] }));
        if (successed) {
            V = ((0, jsx_runtime_1.jsx)(antd_1.Result, { status: "success", title: "绑定微信成功" }));
        }
    }
    else if (type === 'login') {
        V = ((0, jsx_runtime_1.jsx)(antd_1.Space, { direction: "vertical", align: 'center', size: 16, children: (0, jsx_runtime_1.jsx)(antd_1.Button, { disabled: oakExecuting || oakLoading, type: "primary", shape: "round", icon: (0, jsx_runtime_1.jsx)(icons_1.WechatOutlined, {}), size: "large", onClick: () => getCodeAndRedirect(), children: "\u4E00\u952E\u767B\u5F55" }) }));
        if (successed) {
