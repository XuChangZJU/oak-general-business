...
function render() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: web_module_less_1.default.container }, { children: [(0, jsx_runtime_1.jsxs)(tdesign_react_1.Row, { children: [(0, jsx_runtime_1.jsx)(tdesign_react_1.Col, tslib_1.__assign({ xs: 12, sm: 8 }, { children: (0, jsx_runtime_1.jsx)(tdesign_react_1.Space, { children: (0, jsx_runtime_1.jsx)(tdesign_react_1.Button, tslib_1.__assign({ size: "medium", theme: "primary", onClick: function () {
                                    _this.goUpsert();
                                } }, { children: this.t('action.add') })) }) })), (0, jsx_runtime_1.jsx)(tdesign_react_1.Col, tslib_1.__assign({ xs: 12, sm: 4 }, { children: (0, jsx_runtime_1.jsx)(tdesign_react_1.Input, { placeholder: "\u8BF7\u8F93\u5165\u4E66\u540D", value: searchValue, clearable: true, onChange: function (value) {
                    ...
                    },
                    {
                        ...
                        cell: function (_a) {
                            ...
                            return ((0, jsx_runtime_1.jsx)(tdesign_react_1.Tag, tslib_1.__assign({ theme: "primary", size: "small" }, { children: _this.t("book:v.iState.".concat(row.iState)) })));
                        },
                    },
                    {
                        colKey: 'title',
