...
function render() {
    var _this = this;
    var _a = this, features = _a.features, addExtraFile = _a.addExtraFile;
    var _b = this.state, editor = _b.editor, title = _b.title, author = _b.author, abstract = _b.abstract, content = _b.content, html = _b.html, origin = _b.origin, contentTip = _b.contentTip, oakFullpath = _b.oakFullpath;
    return ((0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: web_module_less_1.default.container }, { children: [(0, jsx_runtime_1.jsx)(antd_1.Affix, tslib_1.__assign({ offsetTop: 64 }, { children: (0, jsx_runtime_1.jsx)(editor_for_react_1.Toolbar, { editor: editor, defaultConfig: toolbarConfig, mode: "default" }) })), (0, jsx_runtime_1.jsxs)(antd_1.Row, { children: [(0, jsx_runtime_1.jsx)(antd_1.Col, { flex: 4 }), (0, jsx_runtime_1.jsx)(antd_1.Col, tslib_1.__assign({ flex: 16 }, { children: (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_module_less_1.default.content }, { children: (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: web_module_less_1.default.editorContainer }, { children: [(0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_module_less_1.default.titleContainer }, { children: (0, jsx_runtime_1.jsx)(input_1.default, { onChange: function (e) {
                                                _this.setUpdateData('title', e.target.value);
                                            }, value: title, placeholder: this.t('placeholder.title'), size: "large", maxLength: 64, suffix: "".concat(tslib_1.__spreadArray([], tslib_1.__read((title || '')), false).length, "/64"), className: web_module_less_1.default.titleInput }) })), (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_module_less_1.default.authorContainer }, { children: (0, jsx_runtime_1.jsx)(input_1.default, { onChange: function (e) {
                                                _this.setUpdateData('author', e.target.value);
                                            }, value: author, placeholder: this.t('placeholder.author'), className: web_module_less_1.default.input }) })), contentTip && ((0, jsx_runtime_1.jsx)(antd_1.Alert, { type: "info", message: this.t('tips.content'), closable: true, onClose: function () {
                                            _this.setState({
                                                contentTip: false,
                                            });
                                            ...
                                            overflowY: 'hidden',
                                                            ...
                                                            ], type: "image", origin: "qiniu", tag1: "cover", entity: "article" }) })), (0, jsx_runtime_1.jsx)(antd_1.Col, tslib_1.__assign({ flex: "auto" }, { children: (0, jsx_runtime_1.jsx)(input_1.default.TextArea, { autoSize: {
                                                                minRows: 4,
                                                            }, maxLength: 120, placeholder: this.t('placeholder.abstract'), onChange: function (e) {
                                                                _this.setUpdateData('abstract', e.target.value);
