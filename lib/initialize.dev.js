...
function initialize(type, domain, storageSchema, frontendContextBuilder, backendContextBuilder, aspectDict, triggers, checkers, watchers, timers, startRoutines, initialData, actionDict, actionCascadePathGraph, relationCascadePathGraph, cascadeRemoveDict, colorDict, importations, exportations) {
    ...
    var features = (0, initialize_dev_1.initialize)(storageSchema, frontendContextBuilder, backendContextBuilder, aspectDict2, triggers2, checkers2, watchers2, timers, startRoutines2, data2, actionDict2, actionCascadePathGraph, relationCascadePathGraph, cascadeRemoveDict, colorDict, importations, exportations).features;
