...
createData, user) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var currentToken, schema, userState, _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, application, _l, originToken, tokenData, userState, userId, _m, _o, _p, _q, _r, _s, _t, userData, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5;
        ...
        return tslib_1.__generator(this, function (_18) {
            switch (_18.label) {
                ...
                case 4:
                    ...
                    _6 = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 5: return [4 /*yield*/, _c.apply(_b, _d.concat([(_6.id = _18.sent(),
                            _6.action = 'activate',
                            _6.data = {},
                            _6.filter = {
                                id: user.id,
                ...
                case 12:
                    ...
                    _7 = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 13: return [4 /*yield*/, _f.apply(_e, _g.concat([(_7.id = _18.sent(),
                            _7.action = 'create',
                ...
                case 15:
                    ...
                    _8 = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 16: return [4 /*yield*/, _j.apply(_h, _k.concat([(_8.id = _18.sent(),
                            _8.action = 'update',
                            _8.data = {
                                userId: currentToken.userId,
                            },
                ...
                case 21:
                    _l = tslib_1.__read.apply(void 0, [_18.sent(), 1]), originToken = _l[0];
                    if (originToken) {
                ...
                case 27:
                    ...
                    _10 = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 28: return [4 /*yield*/, _p.apply(_o, _q.concat([(_10.id = _18.sent(),
                            _10.action = 'activate',
                            _10.data = {},
                            _10.filter = {
                                id: userId,
                ...
                case 31:
                    ...
                    _12 = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 32: return [4 /*yield*/, _s.apply(_r, _t.concat([(_12.id = _18.sent(),
                            _12.action = 'create',
                            _12.data = tokenData,
                ...
                case 35:
                    ...
                    _14 = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 36: return [4 /*yield*/, _v.apply(_u, _w.concat([(_14.id = _18.sent(),
                            _14.action = 'create',
                            _14.data = userData,
                            _14), {}]))];
                case 37:
                    ...
                    _15 = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 38: return [4 /*yield*/, _y.apply(_x, _z.concat([(_15.id = _18.sent(),
                            _15.action = 'create',
                            _15.data = tokenData,
                ...
                case 40:
                    ...
                    _16 = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 41: return [4 /*yield*/, _1.apply(_0, _2.concat([(_16.id = _18.sent(),
                            _16.action = 'create',
                ...
                case 43:
                    ...
                    _17 = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 44: return [4 /*yield*/, _4.apply(_3, _5.concat([(_17.id = _18.sent(),
                            _17.action = 'update',
                            _17.data = {
                                userId: userData.id,
                            },
