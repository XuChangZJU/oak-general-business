    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_11) {
            switch (_11.label) {
                ...
                case 1:
                    currentToken = _11.sent();
                    return [4 /*yield*/, context.getApplicationId()];
                case 2:
                    applicationId = _11.sent();
                ...
                case 14:
                    ...
                    _0 = {};
                    return [4 /*yield*/, generateNewId()];
                case 15: return [4 /*yield*/, _h.apply(_g, _j.concat([(_0.id = _11.sent(),
                            _0.data = tokenData,
                            _0.action = 'create',
                            _0), context, {
                            dontCollect: true,
                ...
                case 17:
                    ...
                    _2 = {};
                    return [4 /*yield*/, generateNewId()];
                case 18: return [4 /*yield*/, _l.apply(_k, _m.concat([(_1.data = (_2.id = _11.sent(),
                            _2.userId = user.id,
                ...
                case 23:
                    ...
                    _4 = {};
                    return [4 /*yield*/, generateNewId()];
                case 24: return [4 /*yield*/, _p.apply(_o, _q.concat([(_4.id = _11.sent(),
                            _4.action = 'create',
                            _4.data = mobileData,
                            _4), context, {}]))];
                case 25:
                ...
                case 27:
                    ...
                    _6 = {};
                    return [4 /*yield*/, generateNewId()];
                case 28: return [4 /*yield*/, _s.apply(_r, _t.concat([(_6.id = _11.sent(),
                            _6.action = 'create',
                            _6.data = userData,
                            _6), context, {}]))];
                case 29:
                ...
                case 32:
                    ...
                    _10 = {};
                    return [4 /*yield*/, generateNewId()];
                case 33: return [4 /*yield*/, _v.apply(_u, _w.concat([(_10.id = _11.sent(),
                            _10.action = 'create',
                            _10.data = tokenData,
                            _10), context, {}]))];
                case 34:
