...
function updateUserPassword(params, context, innerLogic) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var userId, prevPassword, captcha, mobile, newPassword, _a, user, _b, lastSuccessfulTemp, count1, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, aliveCaptcha, _o, _p, _q, _r, _s, _t;
        ...
        return tslib_1.__generator(this, function (_2) {
            switch (_2.label) {
                ...
                case 1:
                    ...
                    if (!prevPassword) return [3 /*break*/, 13];
                ...
                case 3:
                    ...
                    if (!(user.password === prevPassword)) return [3 /*break*/, 9];
                    _d = (_c = context).operate;
                    _e = ['user'];
                    _u = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 4: return [4 /*yield*/, _d.apply(_c, _e.concat([(_u.id = _2.sent(),
                            _u.action = 'update',
                            _u.data = {
                ...
                case 6:
                    ...
                    _w = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 7: return [4 /*yield*/, _g.apply(_f, _h.concat([(_v.data = (_w.id = _2.sent(),
                            _w.userId = userId,
                ...
                case 10:
                    ...
                    _y = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 11: return [4 /*yield*/, _k.apply(_j, _l.concat([(_x.data = (_y.id = _2.sent(),
                            _y.userId = userId,
                ...
                case 13:
                    if (!(mobile && captcha)) return [3 /*break*/, 21];
                ...
                case 14:
                    ...
                    if (!aliveCaptcha) return [3 /*break*/, 20];
                    _p = (_o = context).operate;
                    _q = ['user'];
                    _z = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 15: return [4 /*yield*/, _p.apply(_o, _q.concat([(_z.id = _2.sent(),
                            _z.action = 'update',
                            _z.data = {
                                password: newPassword,
                                passwordSha1: (0, password_1.encryptPasswordSha1)(newPassword)
                ...
                case 17:
                    ...
                    _1 = {};
                    return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                case 18: return [4 /*yield*/, _s.apply(_r, _t.concat([(_0.data = (_1.id = _2.sent(),
                            _1.userId = userId,
