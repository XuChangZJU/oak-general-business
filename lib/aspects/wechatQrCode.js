...
function createWechatQrCode(options, context) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var entity, entityId, tag, _a, permanent, props, qrCodeType, applicationId, _b, system, appId, appType, url, _c, applications, sysConfig, id, self_1, self_2, self_3, self_4, publicApp, mpApp, data, type, application, applicationType, config, _d, config2, appId_1, appSecret, wechatInstance, envVersionVersionDict, buffer, str, config2, appId_2, appSecret, wechatInstance, result;
            ...
            switch (_e.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, wechatInstance.getMpUnlimitWxaCode({
                            ...
                            envVersion: envVersionVersionDict[process.env
                                .NODE_ENV],
