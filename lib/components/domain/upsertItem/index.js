...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(antd_1.Form, { colon: true, labelCol: { span: 6 }, wrapperCol: { span: 16 }, children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "\u8BBF\u95EE\u57DF\u540D", required: true, children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8F93\u5165\u57DF\u540D\uFF0C\u4F8B\u5982\uFF1Awww.abc.com", onChange: (e) => {
                        ...
                        }, value: data.url }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "\u8BF7\u6C42\u8DEF\u5F84", required: true, children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { onChange: (e) => {
                            update('apiPath', e.target.value);
                        }, value: data.apiPath }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "\u7AEF\u53E3", required: true, children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { onChange: (e) => {
