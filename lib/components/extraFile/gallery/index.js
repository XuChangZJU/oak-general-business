...
exports.default = OakComponent({
    ...
    methods: {
        getUrl: function (extraFile) {
            ...
            if (fileList[extraFile === null || extraFile === void 0 ? void 0 : extraFile.id]) {
                return this.features.extraFile.getUrl(Object.assign({}, extraFile, { extra1: fileList[extraFile === null || extraFile === void 0 ? void 0 : extraFile.id] }));
            }
        ...
        pushExtraFile: function (options, callback) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a, type, origin, tag1, tag2, entity, entityId, autoUpload, name, extra1, fileType, size, sort, extension, filename, id, updateData, error_1;
                var _b;
                var _this = this;
                return tslib_1.__generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            this.addItem(Object.assign({}, updateData, {
                                ...
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.features.extraFile.upload(updateData, extra1)];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
                        ...
                        case 3:
                            ...
                            throw error_1;
                        case 4: return [4 /*yield*/, this.execute()];
                        case 5:
                            _c.sent();
                            return [3 /*break*/, 7];
                        case 6:
                            ...
                            this.setState({
                                fileList: Object.assign(this.state.fileList, (_b = {}, _b[id] = extra1, _b))
                            });
                            _c.label = 7;
                        case 7: return [2 /*return*/];
                    }
        ...
        onDeleteByMp: function (event) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var value, id, bucket, origin, removeLater, result, confirm_1;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            value = event.currentTarget.dataset.value;
                            id = value.id, bucket = value.bucket, origin = value.origin;
                            removeLater = this.props.removeLater;
                            if (!(removeLater || (origin !== 'unknown' && !bucket))) return [3 /*break*/, 1];
                            this.removeItem(id);
                            return [3 /*break*/, 4];
        ...
        onDeleteByWeb: function (value) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var id, bucket, origin, _a, removeLater, confirm_2;
                var _this = this;
                return tslib_1.__generator(this, function (_b) {
                    id = value.id, bucket = value.bucket, origin = value.origin;
                    _a = this.props.removeLater, removeLater = _a === void 0 ? true : _a;
        ...
        onOpenByMp: function (event) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var value, fileUrl, that, extension, extensions;
                return tslib_1.__generator(this, function (_a) {
                    value = event.currentTarget.dataset.value;
                    fileUrl = this.features.extraFile.getUrl(value);
                    that = this;
    ...
    listeners: {
        ...
        size: function (prev, next) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var size, res, widthRpx, itemSizePercentage;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
