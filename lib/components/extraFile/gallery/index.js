    ...
    methods: {
        getUrl: function (extraFile) {
            ...
            if (fileList[extraFile === null || extraFile === void 0 ? void 0 : extraFile.id]) {
                var url = this.features.extraFile.getUrl(Object.assign({}, extraFile, { extra1: fileList[extraFile === null || extraFile === void 0 ? void 0 : extraFile.id] }));
                return url;
            }
                ...
                return tslib_1.__generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            if (!autoUpload) return [3 /*break*/, 5];
                            if (callback) {
