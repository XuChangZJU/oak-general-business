...
exports.default = OakComponent({
    ...
    methods: {
        ...
        pushExtraFile: function (options, callback) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a, type, origin, tag1, tag2, entity, entityId, autoUpload, name, extra1, fileType, size, sort, extension, filename, updateData, error_1;
                var _this = this;
                                ...
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, this.features.extraFile.upload(updateData, extra1)];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
