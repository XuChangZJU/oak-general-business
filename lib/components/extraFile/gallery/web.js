                        ...
                        return ((0, jsx_runtime_1.jsx)(DragableUploadListItem, { originNode: originNode, file: currentFile, fileList: currentFileList, moveRow: moveRow }));
                            ...
                            },
                            {
                                ...
                                render: function (value, record, index) {
                                    switch (value) {
                                        case "success":
                                            return (0, jsx_runtime_1.jsx)(antd_1.Tag, tslib_1.__assign({ color: "success" }, { children: t("success") }));
                                        case "uploading":
                                            return (0, jsx_runtime_1.jsx)(antd_1.Tag, tslib_1.__assign({ color: "processing" }, { children: t("uploading") }));
                                        default:
                                            return (0, jsx_runtime_1.jsx)(antd_1.Tag, tslib_1.__assign({ color: "warning" }, { children: t("waiting") }));
                                    }
                                },
                            },
                            {
