...
exports.default = OakComponent({
    ...
    methods: {
        ...
        onPickByWeb: function (files) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _this = this;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, Promise.all(files.map(function (file) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.pushExtraFile({
                                                name: file.name,
                                                fileType: file.type,
                                                size: file.size,
                                                extra1: file,
        ...
        pushExtraFile: function (options) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a, origin, type, tag1, avatar, _b, entityId, entity, name, extra1, fileType, size, extension, filename, updateData;
                var _this = this;
