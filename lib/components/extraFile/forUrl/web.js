...
function render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: web_module_less_1.default.imgBox, children: [(0, jsx_runtime_1.jsxs)(antd_1.Space, { direction: "vertical", size: 4, children: [(0, jsx_runtime_1.jsx)(icons_1.PlusOutlined, {}), (0, jsx_runtime_1.jsx)("div", { children: "\u9009\u62E9\u5C01\u9762" })] }), (0, jsx_runtime_1.jsx)("img", { id: "previewImg", src: src, alt: "previewImg", className: web_module_less_1.default.previewImg, style: { display: src ? 'inline-block' : 'none' } }), (0, jsx_runtime_1.jsx)("div", { className: web_module_less_1.default.methodList, children: methods && methods.map(function (ele) { return ((0, jsx_runtime_1.jsx)("div", { className: web_module_less_1.default.methodListItem, onClick: function () {
                        chooseMethod(ele);
                            ...
                            }, placeholder: '\u5982\uFF1Ahttps://www.xxx.com' }) }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Modal, { width: 800, title: t('chooseImage'), open: isModalOpen1, onOk: function () { return onModal1Confirm(selectedId); }, onCancel: closeModal1, children: (renderImgs && renderImgs.length) ? ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Row, { gutter: [4, 4], children: renderImgs.map(function (img) {
                            return (0, jsx_runtime_1.jsx)(antd_1.Col, { span: 4, children: (0, jsx_runtime_1.jsx)(imgBox_1.default, { width: "100%", bordered: true, mode: "select", src: img.renderUrl, selected: selectedId === img.id, onClick: function () {
