...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(antd_1.Form, { colon: true, labelCol: { span: 4 }, wrapperCol: { span: 8 }, children: [((user === null || user === void 0 ? void 0 : user.mobile$user) && ((_a = user === null || user === void 0 ? void 0 : user.mobile$user) === null || _a === void 0 ? void 0 : _a.length) > 0) && (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: '手机号', children: (0, jsx_runtime_1.jsx)(antd_1.Select, { defaultValue: user === null || user === void 0 ? void 0 : user.mobile$user[0].mobile, options: user === null || user === void 0 ? void 0 : user.mobile$user.map(function (ele) {
                        return {
                            label: ele.mobile,
                            value: ele.mobile,
                        };
                    ...
                    }, className: web_module_less_1.default['loginbox-input'], suffix: (0, jsx_runtime_1.jsx)(antd_1.Button, { size: "small", type: "link", disabled: (!mobile) || counter > 0, onClick: function () { return sendCaptcha(mobile); }, children: counter > 0 ? "".concat(counter, "\u79D2\u540E\u53EF\u91CD\u53D1") : '发送验证码' }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: '输入新密码', name: "password", help: validateHelp, rules: [
                    {
                        required: true,
                        message: '请输入密码',
                    ...
                    }, iconRender: function (visible) { return (visible ? (0, jsx_runtime_1.jsx)(icons_1.EyeTwoTone, {}) : (0, jsx_runtime_1.jsx)(icons_1.EyeInvisibleOutlined, {})); }, placeholder: '请再次输入新密码' }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { wrapperCol: { offset: 4 }, children: (0, jsx_runtime_1.jsxs)(antd_1.Space, { children: [(0, jsx_runtime_1.jsx)(antd_1.Button, { type: "primary", onClick: function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
