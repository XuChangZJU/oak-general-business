...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(antd_1.Form, tslib_1.__assign({ colon: true, labelCol: { span: 4 }, wrapperCol: { span: 8 } }, { children: [failTimes > 5 && (0, jsx_runtime_1.jsx)(antd_1.Alert, { message: "\u60A8\u4ECA\u65E5\u5C1D\u8BD5\u6B21\u6570\u8FC7\u591A\uFF0C\u8BF7\u7A0D\u5019\u518D\u8FDB\u884C\u64CD\u4F5C\u6216\u4F7F\u7528\u624B\u673A\u53F7\u9A8C\u8BC1", type: "error" }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, tslib_1.__assign({ label: '输入当前密码', name: "prevPassword", help: validateHelp0, rules: [
                    {
                        required: true,
                        message: '请输入密码',
                    ...
                    }, iconRender: function (visible) { return (visible ? (0, jsx_runtime_1.jsx)(icons_1.EyeTwoTone, {}) : (0, jsx_runtime_1.jsx)(icons_1.EyeInvisibleOutlined, {})); }, placeholder: '请输入当前密码' }) })), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, tslib_1.__assign({ label: '输入新密码', name: "password", help: validateHelp1, rules: [
                    {
                        required: true,
                        message: '请输入密码',
                        validator: function (_, value) {
                    ...
                    }, iconRender: function (visible) { return (visible ? (0, jsx_runtime_1.jsx)(icons_1.EyeTwoTone, {}) : (0, jsx_runtime_1.jsx)(icons_1.EyeInvisibleOutlined, {})); }, placeholder: '请输入新密码' }) })), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, tslib_1.__assign({ label: '确认密码', name: "passwordConfirm", rules: [
                    {
                        ...
                        setPassword2(strValue);
                            ...
                            }); }, disabled: !(failTimes < 5 && prevPassword && password && password.length >= 8 && password === password2) }, { children: "\u63D0\u4EA4" })), (0, jsx_runtime_1.jsx)(antd_1.Button, tslib_1.__assign({ htmlType: "reset", onClick: reset }, { children: "\u91CD\u7F6E" }))] }) }))] })));
}
