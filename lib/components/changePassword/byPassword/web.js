...
function Render(props) {
    ...
    const [prevPassword, setPrevPassword] = (0, react_1.useState)('');
    const [validateHelp0, setValidateHelp0] = (0, react_1.useState)('');
    const [validateStatus0, setValidateStatus0] = (0, react_1.useState)('');
    ...
    return ((0, jsx_runtime_1.jsxs)(antd_1.Form, { colon: true, labelCol: { span: 4 }, wrapperCol: { span: 8 }, children: [failTimes >= 5 && (0, jsx_runtime_1.jsx)(antd_1.Alert, { message: "\u60A8\u4ECA\u65E5\u5C1D\u8BD5\u6B21\u6570\u8FC7\u591A\uFF0C\u8BF7\u7A0D\u5019\u518D\u8FDB\u884C\u64CD\u4F5C\u6216\u4F7F\u7528\u624B\u673A\u53F7\u9A8C\u8BC1", type: "error", style: { marginBottom: 20 } }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: '输入原密码', name: "prevPassword", help: validateHelp0, rules: [
                ...
                ], hasFeedback: true, validateStatus: validateStatus0, children: (0, jsx_runtime_1.jsx)(antd_1.Input.Password, { value: prevPassword, onChange: (e) => {
                        const strValue = e.target.value;
                        setPrevPassword(strValue);
                    }, iconRender: (visible) => (visible ? (0, jsx_runtime_1.jsx)(icons_1.EyeTwoTone, {}) : (0, jsx_runtime_1.jsx)(icons_1.EyeInvisibleOutlined, {})), placeholder: '请输入原密码' }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: '输入新密码', name: "password", help: validateHelp1, rules: [
                    {
                        required: true,
                        message: '请输入新密码',
                        validator: (_, value) => {
                    ...
                    }, iconRender: (visible) => (visible ? (0, jsx_runtime_1.jsx)(icons_1.EyeTwoTone, {}) : (0, jsx_runtime_1.jsx)(icons_1.EyeInvisibleOutlined, {})), placeholder: '请再次输入密码' }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { wrapperCol: { offset: 4 }, children: (0, jsx_runtime_1.jsxs)(antd_1.Space, { children: [(0, jsx_runtime_1.jsx)(antd_1.Button, { htmlType: "reset", type: "primary", onClick: async () => {
