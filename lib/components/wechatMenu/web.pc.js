    ...
    const items = [
        {
            key: '1',
            label: '通用菜单',
            children: (0, jsx_runtime_1.jsx)(menu_1.default, { menuId: menuId ? menuId : undefined, oakPath: '$wechatMenu', applicationId: applicationId, oakAutoUnmount: true, menuType: menuType }),
        },
        {
            key: '2',
            label: '个性化菜单',
            children: (0, jsx_runtime_1.jsxs)("div", { className: web_module_less_1.default.conditionalMenu, children: [(0, jsx_runtime_1.jsx)("div", { className: web_module_less_1.default.tagList, children: (0, jsx_runtime_1.jsx)(tagList_1.default, { oakAutoUnmount: true, oakPath: '$wechatPublicTag', applicationId: applicationId, getTag: getTag }) }), tag.id ? ((0, jsx_runtime_1.jsx)(conditionalMenu_1.default, { oakPath: '$conditionalMenu', applicationId: applicationId, oakAutoUnmount: true, tagId: tag.id, menuType: menuType })) : ((0, jsx_runtime_1.jsx)("div", { className: web_module_less_1.default.tagHelp, children: "\u8BF7\u9009\u62E9\u4E00\u4E2A\u6807\u7B7E" }))] }),
        },
    ];
    if (oakFullpath) {
        return ((0, jsx_runtime_1.jsx)("div", { children: is_menu_open ? ((0, jsx_runtime_1.jsx)("div", { className: web_module_less_1.default.tabs, children: (0, jsx_runtime_1.jsx)(antd_1.Tabs, { defaultActiveKey: '1', items: items, onChange: (key) => {
                        if (key === '1') {
                            setMenuType('common');
                        }
                        else {
