    ...
    if (oakFullpath && row) {
        if (!show) {
            ...
            if (!row.parentId && articleMenuId) {
                ...
                return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: web_pc_module_less_1.default.test, onClick: function () {
                                setShowSub(!showSub);
                                setNewBreadcrumbItems(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(breadItems), false), [row === null || row === void 0 ? void 0 : row.name], false));
                            }, style: showSub ? { background: '#f5f5f5' } : { background: 'transparent' } }, { children: [(0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_pc_module_less_1.default.ne }, { children: (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: web_pc_module_less_1.default.name }, { children: [logo ? ((0, jsx_runtime_1.jsx)(antd_1.Image, { height: 26, width: 26, src: logo, preview: false, style: { marginRight: 4 } })) : null, (0, jsx_runtime_1.jsx)("div", { children: row === null || row === void 0 ? void 0 : row.name })] })) })), (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_pc_module_less_1.default.control }, { children: (hasSubArticles || hasSubMenus) ? (showSub ?
                                        (0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.downArrow }) :
                                        (0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.leftArrow })) : (0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.ph }) }))] })), showSub && ((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_pc_module_less_1.default.sub3, style: { background: '#f5f5f5' } }, { children: Sub }))), contextHolder] }));
            }
        }
    }
    return null;
