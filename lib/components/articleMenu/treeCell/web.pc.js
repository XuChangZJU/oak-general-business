...
function Render(props) {
    var _this = this;
    var _a = props.data, row = _a.row, allowCreateSubArticle = _a.allowCreateSubArticle, allowCreateSubMenu = _a.allowCreateSubMenu, allowRemove = _a.allowRemove, onRemove = _a.onRemove, onUpdateName = _a.onUpdateName, oakFullpath = _a.oakFullpath, logo = _a.logo, onChildEditArticleChange = _a.onChildEditArticleChange, editArticle = _a.editArticle, show = _a.show, getBreadcrumbItemsByParent = _a.getBreadcrumbItemsByParent, breadItems = _a.breadItems, drawerOpen = _a.drawerOpen, changeDrawerOpen = _a.changeDrawerOpen, selectedArticleId = _a.selectedArticleId, openArray = _a.openArray, getTopInfo = _a.getTopInfo, articleId = _a.articleId, articleMenuId = _a.articleMenuId, getSideInfo = _a.getSideInfo, currentArticle = _a.currentArticle, setCurrentArticle = _a.setCurrentArticle;
        ...
        if (!show) {
            ...
            if (allowCreateSubArticle) {
                items.push({
                    ...
                    label: ((0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.addAction, onClick: function () {
                            modal.confirm({
                                title: '输入文章标题',
                                cancelText: '取消',
                                okText: '提交',
            ...
            return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: web_pc_module_less_1.default.container, children: [(0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.ne, children: 
                                ...
                                (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_1.Button, { type: "text", icon: (0, jsx_runtime_1.jsx)(icons_1.EditOutlined, {}), size: "small", onClick: function () {
                                        ...
                                        (0, jsx_runtime_1.jsx)(antd_1.Button, { type: "text", icon: (0, jsx_runtime_1.jsx)(icons_1.DownOutlined, {}), size: "small", onClick: function () { return setShowSub(true); } })) : (0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.ph })] })] }), showSub && ((0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.sub, children: Sub })), contextHolder] }));
        }
        else {
            var Sub = showSub && hasSubArticles ? ((0, jsx_runtime_1.jsx)(treeList_2.default, { onChildEditArticleChange: onChildEditArticleChange, articleMenuId: row.id, oakPath: "".concat(oakFullpath, ".article$articleMenu"), show: show, getBreadcrumbItemsByParent: getBreadcrumbItemsByParent, breadcrumbItems: newBreadcrumbItems, drawerOpen: drawerOpen, changeDrawerOpen: changeDrawerOpen, selectedArticleId: selectedArticleId, openArray: openArray ? openArray : undefined, getTopInfo: getTopInfo, articleId: articleId, currentArticle: currentArticle, setCurrentArticle: setCurrentArticle })) : ((0, jsx_runtime_1.jsx)(treeList_1.default, { parentId: row.id, oakPath: "".concat(oakFullpath, ".articleMenu$parent"), onGrandChildEditArticleChange: onChildEditArticleChange, show: show, getBreadcrumbItems: getBreadcrumbItemsByParent, breadcrumbItems: newBreadcrumbItems, drawerOpen: drawerOpen, changeDrawerOpen: changeDrawerOpen, selectedArticleId: selectedArticleId, openArray: openArray ? openArray : undefined, getTopInfo: getTopInfo, articleId: articleId, currentArticle: currentArticle, setCurrentArticle: setCurrentArticle }));
            if (!row.parentId && articleMenuId) {
                ...
                return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: web_pc_module_less_1.default.test, onClick: function () {
                                setShowSub(!showSub);
                                setNewBreadcrumbItems(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(breadItems), false), [row === null || row === void 0 ? void 0 : row.name], false));
                            }, style: showSub ? { background: '#f5f5f5' } : { background: 'transparent' }, children: [(0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.ne, children: (0, jsx_runtime_1.jsxs)("div", { className: web_pc_module_less_1.default.name, children: [logo ? ((0, jsx_runtime_1.jsx)(antd_1.Image, { height: 26, width: 26, src: logo, preview: false, style: { marginRight: 4 } })) : null, (0, jsx_runtime_1.jsx)("div", { children: row === null || row === void 0 ? void 0 : row.name })] }) }), (0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.control, children: (hasSubArticles || hasSubMenus) ? (showSub ?
