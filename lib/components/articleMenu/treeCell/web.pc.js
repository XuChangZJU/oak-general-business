...
function Render(props) {
    ...
    if (oakFullpath && row) {
        if (!show) {
            ...
            var Sub = showSub && hasSubArticles ? ((0, jsx_runtime_1.jsx)(treeList_2.default, { onChildEditArticleChange: onChildEditArticleChange, articleMenuId: row.id, oakPath: "".concat(oakFullpath, ".article$articleMenu"), show: show, getBreadcrumbItemsByParent: getBreadcrumbItemsByParent, breadcrumbItems: newBreadcrumbItems, drawerOpen: drawerOpen, changeDrawerOpen: changeDrawerOpen, selectedArticleId: selectedArticleId, openArray: openArray ? openArray : undefined })) : ((0, jsx_runtime_1.jsx)(treeList_1.default, { parentId: row.id, oakPath: "".concat(oakFullpath, ".articleMenu$parent"), onGrandChildEditArticleChange: onChildEditArticleChange, show: show, getBreadcrumbItems: getBreadcrumbItemsByParent, breadcrumbItems: newBreadcrumbItems, drawerOpen: drawerOpen, changeDrawerOpen: changeDrawerOpen, selectedArticleId: selectedArticleId, openArray: openArray ? openArray : undefined }));
            return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: web_pc_module_less_1.default.container2, onClick: function () {
                            setShowSub(!showSub);
                            setNewBreadcrumbItems(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(breadItems), false), [row === null || row === void 0 ? void 0 : row.name], false));
                        } }, { children: [(0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_pc_module_less_1.default.ne }, { children: (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: web_pc_module_less_1.default.name }, { children: [logo ? ((0, jsx_runtime_1.jsx)(antd_1.Image, { height: 26, width: 26, src: logo, preview: false, style: { marginRight: 4 } })) : null, (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ style: { width: 204 } }, { children: row === null || row === void 0 ? void 0 : row.name }))] })) })), (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_pc_module_less_1.default.control }, { children: (hasSubArticles || hasSubMenus) ? (showSub ?
                                    (0, jsx_runtime_1.jsx)(icons_1.DownOutlined, {}) :
                                    (0, jsx_runtime_1.jsx)(icons_1.RightOutlined, {})) : (0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.ph }) }))] })), showSub && ((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_pc_module_less_1.default.sub2 }, { children: Sub }))), contextHolder] }));
        }
    }
    return null;
}
