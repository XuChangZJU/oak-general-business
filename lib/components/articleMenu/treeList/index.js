...
exports.default = OakComponent({
    ...
    properties: {
        ...
        getSearchOpen: function (searchOpenArray) { return undefined; },
        getSideInfo: function (data) { return undefined; },
        currentArticle: '',
        setCurrentArticle: function (id) { return undefined; },
    },
    projection: {
        id: 1,
        name: 1,
    ...
    methods: {
        ...
        getSearchArticle: function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var rows, _a, entity, entityId, articleId, article, toggleItems, getArticleMenu;
                var _this = this;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            rows = this.state.rows;
                            _a = this.props, entity = _a.entity, entityId = _a.entityId, articleId = _a.articleId;
                        ...
                        case 1:
                            ...
                            toggleItems = [];
                            getArticleMenu = function (parentId) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var articleMenu, parentToggleItems;
                                var _a, _b;
                                return tslib_1.__generator(this, function (_c) {
                                    switch (_c.label) {
                                        ...
                                        case 1:
                                            ...
                                            if (articleMenu && articleMenu.length > 0 && !((_a = articleMenu[0]) === null || _a === void 0 ? void 0 : _a.parentId)) {
                                                toggleItems.push(articleMenu[0].id);
                                                return [2 /*return*/, toggleItems];
                                            }
                                            if (!(articleMenu && articleMenu.length > 0 && ((_b = articleMenu[0]) === null || _b === void 0 ? void 0 : _b.parentId))) return [3 /*break*/, 3];
                                            toggleItems.push(articleMenu[0].id);
                                            return [4 /*yield*/, getArticleMenu(articleMenu[0].parentId)];
                                        case 2:
                                            parentToggleItems = _c.sent();
                            ...
                            ;
                            return [2 /*return*/, toggleItems.reverse()];
                    }
                });
            });
        }
