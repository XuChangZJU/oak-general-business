...
function Render(props) {
    ...
    const columns = [
        ...
        },
        {
            ...
            title: '更新时间',
            render: (value, record, index) => {
                return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, dayjs_1.default)(value * 1000).format('YYYY-MM-DD HH:mm') });
            }
        },
    ];
    const newsColumns = [
    ...
    if (type === 'image') {
        columns.splice(1, 0, {
            ...
            title: '图片',
            render: (value, record, index) => {
                return (0, jsx_runtime_1.jsx)("img", { style: { width: 120, height: 70 }, src: getImg(value) });
            },
        });
    }
    else if (type === 'voice') {
        columns.splice(1, 0, {
            ...
            title: '音频',
            render: (value, record, index) => {
                return (0, jsx_runtime_1.jsxs)("a", { href: getImg(value), download: true, style: { color: '#1677FF', cursor: 'pointer' }, children: [(0, jsx_runtime_1.jsx)(icons_1.DownloadOutlined, {}), record.media_id] });
            },
        });
    }
    else if (type === 'video') {
