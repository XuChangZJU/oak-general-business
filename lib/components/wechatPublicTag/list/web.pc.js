...
function Render(props) {
    ...
    const [detailOpen, setDetailOpen] = (0, react_1.useState)(false);
    const [oakId, setOakId] = (0, react_1.useState)('');
    const [tagName, setTagName] = (0, react_1.useState)('');
    const [text, setText] = (0, react_1.useState)('');
    const [tagInfo, setTagInfo] = (0, react_1.useState)({});
    ...
    return ((0, jsx_runtime_1.jsx)(pageHeader_1.default, { title: "\u5FAE\u4FE1\u516C\u4F17\u53F7\u6807\u7B7E", showBack: showBack, children: (0, jsx_runtime_1.jsxs)("div", { className: web_module_less_1.default.container, children: [(0, jsx_runtime_1.jsxs)(antd_1.Space, { style: { marginBottom: 20 }, children: [(0, jsx_runtime_1.jsx)(antd_1.Button, { type: "primary", onClick: () => {
                            ...
                            }, children: "\u4E00\u952E\u62C9\u53D6" })] }), (0, jsx_runtime_1.jsx)(upsert_1.default, { isUpdate: oakId ? true : false, oakAutoUnmount: true, open: open, changeOpen: changeOpen, changeText: changeText, text: text, tagName: tagName, addTag: addTag, editTag: editTag }), (0, jsx_runtime_1.jsx)(antd_1.Modal, { title: '\u6807\u7B7E\u8BE6\u60C5', onCancel: () => setDetailOpen(false), footer: null, open: detailOpen, width: 800, children: (0, jsx_runtime_1.jsxs)(antd_1.Descriptions, { bordered: true, column: 3, children: [(0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, { label: '\u6807\u7B7E\u540D', children: tagInfo.text }), (0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, { label: '\u5FAE\u4FE1\u7AEFid', children: tagInfo.wechatId ? tagInfo.wechatId : '--' }), (0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, { label: '\u72B6\u6001', children: tagInfo.iState === 'wait' ? '待同步' : tagInfo.iState === 'success' ? '同步成功' : '同步失败' }), (0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, { label: '\u540C\u6B65\u65F6\u95F4', children: tagInfo.syncAt ? (0, dayjs_1.default)(tagInfo.syncAt).format('YYYY-MM-DD HH:mm') : '--' }), (0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, { label: '\u521B\u5EFA\u65F6\u95F4', children: (0, dayjs_1.default)(tagInfo.$$createAt$$).format('YYYY-MM-DD HH:mm') }), (0, jsx_runtime_1.jsx)(antd_1.Descriptions.Item, { label: '\u66F4\u65B0\u65F6\u95F4', children: (0, dayjs_1.default)(tagInfo.$$updateAt$$).format('YYYY-MM-DD HH:mm') })] }) }), (0, jsx_runtime_1.jsx)(antd_1.Table, { loading: oakLoading, dataSource: list, rowKey: "id", columns: [
                        {
                            dataIndex: '$$seq$$',
                            title: '序号',
                            width: 100,
                        ...
                        },
                        {
                            ...
                            render: (value, record, index) => {
                                return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_1.Button, { type: "link", onClick: () => {
                                            ...
                                            (0, jsx_runtime_1.jsx)(antd_1.Button, { type: "link", onClick: () => {
                                                    setOpen(true);
                                                    setOakId(record.id);
                                                    setText(record.text);
