...
function Render(props) {
    ...
    var LoginCaptcha = ((0, jsx_runtime_1.jsxs)(antd_1.Form, { colon: true, children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, { name: "mobile", children: (0, jsx_runtime_1.jsx)(antd_1.Input, { allowClear: true, value: mobile, type: "tel", size: "large", maxLength: 11, prefix: (0, jsx_runtime_1.jsx)(icons_1.MobileOutlined, {}), placeholder: t('placeholder.Mobile'), onChange: function (e) {
                        setMobile(e.target.value);
                    }, className: web_module_less_1.default['loginbox-input'] }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { name: "captcha", children: (0, jsx_runtime_1.jsx)(antd_1.Input, { allowClear: true, value: captcha, size: "large", maxLength: 4, placeholder: t('placeholder.Captcha'), onChange: function (e) {
                        setCaptcha(e.target.value);
                    }, className: web_module_less_1.default['loginbox-input'], suffix: (0, jsx_runtime_1.jsx)(antd_1.Button, { size: "small", type: "link", disabled: !!disabled || !validMobile || counter > 0, onClick: function () { return sendCaptcha(mobile); }, children: counter > 0
                            ? counter + t('resendAfter')
                            : t('Send') }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { children: (0, jsx_runtime_1.jsx)(antd_1.Button, { block: true, size: "large", type: "primary", disabled: disabled || !allowSubmit || loading, loading: loading, onClick: function () { return loginByMobile(mobile, password, captcha); }, children: t('Login') }) })] }));
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: web_module_less_1.default['loginbox-main'], children: (0, jsx_runtime_1.jsxs)("div", { className: (0, classnames_1.default)(web_module_less_1.default['loginbox-wrap'], (_a = {},
                _a[web_module_less_1.default['loginbox-wrap__mobile']] = width === 'xs',
                _a)), children: [(options === null || options === void 0 ? void 0 : options.length) > 1 && ((0, jsx_runtime_1.jsx)("div", { className: web_module_less_1.default['loginbox-hd'], children: (0, jsx_runtime_1.jsx)(antd_1.Segmented, { className: web_module_less_1.default.segmented, value: loginMode, block: true, onChange: setLoginMode, options: options.map(function (ele) { return ({
                            value: ele.value,
                            label: t("".concat(ele.label)),
                        }); }) }) })), (0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)(web_module_less_1.default['loginbox-bd'], (_b = {},
                        _b[web_module_less_1.default['loginbox-bd__grant']] = isSupportGrant,
                        _b)), children: isSupportGrant ? ((0, jsx_runtime_1.jsx)("div", { className: web_module_less_1.default['loginbox-grant'], children: (0, jsx_runtime_1.jsx)(weChatLoginGrant_1.default, { disabled: !!disabled, disableText: disabled, appId: appId, scope: "snsapi_userinfo", redirectUri: redirectUri, state: state }) })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { className: web_module_less_1.default['loginbox-password'], style: {
