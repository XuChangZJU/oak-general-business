                ...
                onEdit: function (targetKey, action) {
                    ...
                    ? sms.map(function (ele, idx) { return ({
                        ...
                        children: ((0, jsx_runtime_1.jsxs)(antd_1.Form, { colon: false, labelAlign: "left", layout: "vertical", style: { marginTop: 10 }, children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "accessKeyId", name: "accessKeyId", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165accessKeyId", type: "text", value: ele.accessKeyId, onChange: function (e) {
                                            ...
                                            } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "defaultSignName", name: "defaultSignName", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165defaultSignName", type: "text", value: ele.defaultSignName, onChange: function (e) {
                                                return setValue("".concat(idx, ".defaultSignName"), e.target.value);
                                            } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "templates", name: "templates", children: (0, jsx_runtime_1.jsx)(antd_1.Tabs, { tabPosition: 'top', size: 'middle', type: "editable-card", 
                                            ...
                                            ? Object.keys(ele.templates).map(function (name, idx) {
                                                ...
                                                return {
                                                    ...
                                                    children: ((0, jsx_runtime_1.jsxs)(antd_1.Form, { colon: true, labelAlign: "left", layout: "vertical", style: {
                                                            marginTop: 10,
                                                        }, children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "signName", name: "signName", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165signName", type: "text", value: template.signName, onChange: function (e) {
                                                                            return setValue("".concat(idx, ".templates.").concat(name, ".signName"), e
                                                                                .target
                                                                                .value);
                                                                        } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "code", name: "code", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165code", type: "text", value: template.code, onChange: function (e) {
                    ...
                    : [] }), (0, jsx_runtime_1.jsx)(antd_1.Modal, { title: "\u65B0\u5EFA\u6A21\u7248\u6807\u7B7E", onCancel: function () {
                    setModal(false);
                    setLabelType('');
                }, onOk: function () {
                    if (!labelType) {
                ...
                onEdit: function (targetKey, action) {
                    ...
                    ? sms.map(function (ele, idx) { return ({
                        ...
                        children: ((0, jsx_runtime_1.jsxs)(antd_1.Form, { colon: false, labelAlign: "left", layout: "vertical", style: { marginTop: 10 }, children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "secretId", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165secretId", type: "text", value: ele.secretId, onChange: function (e) {
                                            ...
                                            } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "smsSdkAppId", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165smsSdkAppId", type: "text", value: ele.smsSdkAppId, onChange: function (e) {
                                                return setValue("".concat(idx, ".smsSdkAppId"), e.target.value);
                                            } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "defaultSignName", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165defaultSignName", type: "text", value: ele.defaultSignName, onChange: function (e) {
                                                return setValue("".concat(idx, ".defaultSignName"), e.target.value);
                                            } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "templates", children: (0, jsx_runtime_1.jsx)(antd_1.Tabs, { tabPosition: 'top', size: 'middle', type: "editable-card", 
                                        // hideAdd={!(Object.keys(ele.templates).length > 0)}
                                        onEdit: function (targetKey, action) {
                                            if (action === 'add') {
                                                setSmsIndex("".concat(idx));
                                            ...
                                            ? Object.keys(ele.templates).map(function (name, idx) {
                                                ...
                                                return {
                                                    ...
                                                    children: ((0, jsx_runtime_1.jsxs)(antd_1.Form, { colon: true, labelAlign: "left", layout: "vertical", style: {
                                                            marginTop: 10,
                                                        }, children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "signName", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165signName", type: "text", value: template.signName, onChange: function (e) {
                                                                            return setValue("".concat(idx, ".templates.").concat(name, ".signName"), e
                                                                                .target
                                                                                .value);
                                                                        } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "code", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165code", type: "text", value: template.code, onChange: function (e) {
                                                                            return setValue("".concat(idx, ".templates.").concat(name, ".code"), e
                                                                                .target
                                                                                .value);
                                                                        } }) }) })] })),
