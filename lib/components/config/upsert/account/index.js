...
function TencentAccount(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(antd_1.Col, { flex: "auto", children: [(0, jsx_runtime_1.jsx)(antd_1.Divider, { orientation: "left", className: web_module_less_1.default.title, children: "\u817E\u8BAF\u4E91\u914D\u7F6E" }), (0, jsx_runtime_1.jsx)(antd_1.Tabs, { tabPosition: 'top', size: 'middle', type: "editable-card", hideAdd: !(accounts.length > 0), onEdit: function (targetKey, action) {
                    if (action === 'add') {
                    ...
                    ? accounts.map(function (ele, idx) { return ({
                        ...
                        children: ((0, jsx_runtime_1.jsxs)(antd_1.Form, { colon: false, labelAlign: "left", layout: "vertical", style: { marginTop: 10 }, children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "secretId", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165secretId", type: "text", value: ele.secretId, onChange: function (e) {
                                            ...
                                            } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "secretKey", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165secretKey", type: "text", value: ele.secretKey, onChange: function (e) {
                                                return setValue("".concat(idx, ".secretKey"), e.target.value);
                                            } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "region", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165region", type: "text", value: ele.region, onChange: function (e) {
                                                return setValue("".concat(idx, ".region"), e.target.value);
                                            } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "endpoint", 
                                    // name="endpoint"
                                    tooltip: "\u8BBF\u95EE\u7684\u57DF\u540D\uFF0C\u5982\uFF1Atencentcloudapi.com", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165endpoint", type: "text", value: ele.endpoint, onChange: function (e) {
                                            ...
                                            } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "\u77ED\u4FE1endpoint", 
                                    //name="smsEndpoint"
                    ...
                    : [
                        {
                            ...
                            children: ((0, jsx_runtime_1.jsxs)(antd_1.Form, { colon: true, labelAlign: "left", layout: "vertical", style: { marginTop: 10 }, children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "secretId", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165secretId", type: "text", value: "", onChange: function (e) {
                                                ...
                                                } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "secretKey", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165secretKey", type: "text", value: "", onChange: function (e) {
                                                    return setValue("0.secretKey", e.target.value);
                                                } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "region", 
                                        // name="region"
...
function QiniuAccount(props) {
    var accounts = props.accounts, setValue = props.setValue, removeItem = props.removeItem, addItem = props.addItem;
    return ((0, jsx_runtime_1.jsxs)(antd_1.Col, { flex: "auto", children: [(0, jsx_runtime_1.jsx)(antd_1.Divider, { orientation: "left", className: web_module_less_1.default.title, children: "\u4E03\u725B\u4E91\u914D\u7F6E" }), (0, jsx_runtime_1.jsx)(antd_1.Tabs, { tabPosition: 'top', size: 'middle', type: "editable-card", hideAdd: !(accounts.length > 0), onEdit: function (targetKey, action) {
                    if (action === 'add') {
                        addItem('', accounts.length);
                    }
                    else {
...
function AliAccount(props) {
    var accounts = props.accounts, setValue = props.setValue, removeItem = props.removeItem, addItem = props.addItem;
    return ((0, jsx_runtime_1.jsxs)(antd_1.Col, { flex: "auto", children: [(0, jsx_runtime_1.jsx)(antd_1.Divider, { orientation: "left", className: web_module_less_1.default.title, children: "\u963F\u91CC\u4E91\u914D\u7F6E" }), (0, jsx_runtime_1.jsx)(antd_1.Tabs, { tabPosition: 'top', size: 'middle', type: "editable-card", hideAdd: !(accounts.length > 0), onEdit: function (targetKey, action) {
                    if (action === 'add') {
                        addItem('', accounts.length);
                    }
                    else {
                    ...
                    ? accounts.map(function (ele, idx) { return ({
                        ...
                        children: ((0, jsx_runtime_1.jsxs)(antd_1.Form, { colon: false, labelAlign: "left", layout: "vertical", style: { marginTop: 10 }, children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "accessKeyId", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165accessKeyId", type: "text", value: ele.accessKeyId, onChange: function (e) {
                                            ...
                                            } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "accessKeySecret", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165accessKeySecret", type: "text", value: ele.accessKeySecret, onChange: function (e) {
                                                return setValue("".concat(idx, ".accessKeySecret"), e.target.value);
                                            } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "regionId", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165regionId", type: "text", value: ele.regionId, onChange: function (e) {
                                    ...
                                    tooltip: "\u8BBF\u95EE\u7684\u57DF\u540D\uFF0C\u5982\uFF1Adysmsapi.aliyuncs.com", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165endpoint", type: "text", value: ele.endpoint, onChange: function (e) {
                                                return setValue("".concat(idx, ".endpoint"), e.target.value);
                                            } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "apiVersion", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165apiVersion", type: "text", value: ele.apiVersion, onChange: function (e) {
                    ...
                    : [
                        {
                            ...
                            children: ((0, jsx_runtime_1.jsxs)(antd_1.Form, { colon: true, labelAlign: "left", layout: "vertical", style: { marginTop: 10 }, children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "accessKeyId", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165accessKeyId", type: "text", value: "", onChange: function (e) {
                                                ...
                                                } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "accessKeySecret", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165accessKeySecret", type: "text", value: "", onChange: function (e) {
                                                    return setValue("0.accessKeySecret", e.target.value);
                                                } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "regionId", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165regionId", type: "text", value: "", onChange: function (e) {
                                        ...
                                        tooltip: "\u8BBF\u95EE\u7684\u57DF\u540D\uFF0C\u5982\uFF1Adysmsapi.aliyuncs.com", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165endpoint", type: "text", value: "", onChange: function (e) {
                                                ...
                                                } }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: "apiVersion", children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Input, { placeholder: "\u8BF7\u8F93\u5165apiVersion", type: "text", value: "", onChange: function (e) {
...
function AmapAccount(props) {
    var accounts = props.accounts, setValue = props.setValue, removeItem = props.removeItem, addItem = props.addItem;
    return ((0, jsx_runtime_1.jsxs)(antd_1.Col, { flex: "auto", children: [(0, jsx_runtime_1.jsx)(antd_1.Divider, { orientation: "left", className: web_module_less_1.default.title, children: "\u9AD8\u5FB7\u4E91\u914D\u7F6E" }), (0, jsx_runtime_1.jsx)(antd_1.Tabs, { tabPosition: "top", size: "middle", type: "editable-card", hideAdd: !(accounts.length > 0), onEdit: function (targetKey, action) {
                    if (action === 'add') {
                        addItem('', accounts.length);
                    }
                    else {
