...
function Color(props) {
    ...
    ;
    return ((0, jsx_runtime_1.jsx)(antd_1.Form, { children: Colors.map(function (ele) { return ((0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: ele, 
            // required
            tooltip: "\u8BBE\u7F6E\u7CFB\u7EDF\u3010".concat(ele, "\u3011\u989C\u8272"), children: (0, jsx_runtime_1.jsxs)(antd_1.Space.Compact, { block: true, children: [(0, jsx_runtime_1.jsx)(antd_1.ColorPicker, { onChangeComplete: function (color) {
