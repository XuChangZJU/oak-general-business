...
function render(props) {
    ...
    const [bridgeId, setBridgeId] = (0, react_1.useState)('');
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_1.Table, { loading: oakLoading, dataSource: list, rowKey: "id", columns: [
                    ...
                    setQrCodeOpen(false);
                }, footer: null, children: (0, jsx_runtime_1.jsx)(detail_1.default, { oakId: bridgeId, oakAutoUnmount: true, oakPath: "$bridge/list-bridge/detail" }) })] }));
}
