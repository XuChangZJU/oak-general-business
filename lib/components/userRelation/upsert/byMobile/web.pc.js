                        ...
                        },
                        {
                            ...
                            message: '请输入11位手机号',
                                ...
                                onMobileChange(strValue);
                                    ...
                                    !oakExecutable ||
                                    (isNew && !passwordConfirm) }, { children: t('common::action.confirm') })), (0, jsx_runtime_1.jsx)(antd_1.Button, tslib_1.__assign({ htmlType: "reset", onClick: function () { return onReset(); }, style: { flex: 1 } }, { children: t('common::reset') }))] }) })) }))] })));
}
