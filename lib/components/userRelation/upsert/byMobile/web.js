...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(antd_mobile_1.Form, { footer: (0, jsx_runtime_1.jsxs)("div", { className: mobile_module_less_1.default['btn-container'], children: [(0, jsx_runtime_1.jsx)(antd_mobile_1.Button, { color: "primary", style: { flex: 2 }, onClick: function () {
                        onConfirm();
                    }, disabled: !oakExecutable, children: t('common::action.confirm') }), (0, jsx_runtime_1.jsx)(antd_mobile_1.Button, { style: { flex: 1 }, onClick: function () { return onReset(); }, children: t('common::reset') })] }), children: [(0, jsx_runtime_1.jsx)(antd_mobile_1.Form.Item, { label: "\u624B\u673A\u53F7\u7801", name: "mobile", rules: [
                    {
                        required: true,
                        message: '手机号不能为空',
                    },
