...
function Render(props) {
    ...
    if (grantMethodCount === 0) {
        ...
        if (grantByEmail) {
            ...
            SubPart = ((0, jsx_runtime_1.jsx)(byUserEntityGrant_1.default, { qrCodeType: qrCodeType, entity: entity, entityId: entityId, relations: relations, oakPath: "$userRelation-upsert-by-userEntityGrant", oakAutoUnmount: true, redirectToAfterConfirm: redirectToAfterConfirm, claimUrl: claimUrl }));
        }
    }
    else {
        const items = [
        ...
        SubPart = ((0, jsx_runtime_1.jsx)(antd_mobile_1.Tabs, { className: mobile_module_less_1.default.tab, children: items2.map(ele => ((0, jsx_runtime_1.jsx)(antd_mobile_1.Tabs.Tab, { title: ele.label, children: ele.children }, ele.key))) }));
    }
    return SubPart;
}
