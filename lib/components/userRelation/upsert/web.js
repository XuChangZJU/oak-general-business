...
function Render(props) {
    ...
    if (grantMethodCount === 0) {
        ...
        SubPart = ((0, jsx_runtime_1.jsx)(antd_mobile_1.Tabs, { children: items2.map(function (ele) { return (0, jsx_runtime_1.jsx)(antd_mobile_1.Tabs.Tab, tslib_1.__assign({ title: ele.label }, { children: ele.children }), ele.key); }) }));
    }
    return SubPart;
}
