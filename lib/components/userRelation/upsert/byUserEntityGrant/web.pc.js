...
function render(props) {
    ...
    const P = !!userEntityGrantId ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_1.Alert, { showIcon: true, message: t('shareCode'), type: "info", style: { marginBottom: 16 } }), (0, jsx_runtime_1.jsx)(share_1.default, { showBack: false, oakId: userEntityGrantId, oakAutoUnmount: true, oakPath: "$userRelation/upsert/byUserEntityGrant-userEntityGrant/detail" }), (0, jsx_runtime_1.jsx)("div", { style: {
                    width: '100%',
                    display: 'flex',
                    justifyContent: 'flex-end',
                }, children: (0, jsx_runtime_1.jsx)(antd_1.Button, { type: "primary", onClick: () => setInit(), children: t('restart') }) })] })) : ((0, jsx_runtime_1.jsxs)(antd_1.Form, { labelCol: { span: 4 }, wrapperCol: { span: 8 }, children: [(0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: t('userEntityGrant:attr.relationIds'), required: true, children: (0, jsx_runtime_1.jsx)(antd_1.Checkbox.Group, { value: relationIds || [], onChange: (val) => {
                        update({ relationIds: val });
                    }, options: relations?.map((ele) => ({
                        value: ele.id,
                        label: ele.display ||
                            t(`${relationEntity}:r.${ele.name}`),
                    })) }) }), relationIds?.length > 1 && ((0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: t('userEntityGrant:attr.rule'), help: t('helpRule'), children: (0, jsx_runtime_1.jsx)(antd_1.Radio.Group, { value: rule, onChange: ({ target }) => update({ rule: target.value }), options: rules.map((ele) => ({
                        value: ele,
                        label: t(`userEntityGrant:v.rule.${ele}`)
                    })) }) })), type === 'grant' && ((0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: t('multiple'), required: true, help: t('helpMutiple'), children: (0, jsx_runtime_1.jsx)(antd_1.Switch, { checked: multiple || false, onChange: (val) => update({ multiple: val }) }) })), (0, jsx_runtime_1.jsx)(antd_1.Form.Item, { label: t('userEntityGrant:attr.expiresAt'), required: true, 
                // name="period"
                // rules={[
                //     {
                //         required: true,
