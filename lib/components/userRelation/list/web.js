...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: mobile_module_less_1.default.container, children: [(0, jsx_runtime_1.jsxs)("span", { className: mobile_module_less_1.default.header, children: [(0, jsx_runtime_1.jsx)("div", { style: { flex: 1 }, children: (0, jsx_runtime_1.jsx)(antd_mobile_1.Input, { placeholder: t('search'), value: searchValue, onChange: function (value) {
                            ...
                            }, onEnterPress: function () { return refresh(); }, clearable: true, onClear: function () { return removeNamedFilterByName('name'); } }) }), (0, jsx_runtime_1.jsx)(antd_mobile_1.Button, { size: 'small', color: 'primary', onClick: function () { return goUpsert(); }, children: t('common::action.create') })] }), (0, jsx_runtime_1.jsx)(antd_mobile_1.List, { children: users === null || users === void 0 ? void 0 : users.map(function (ele, index) {
                    var _a;
                    return ((0, jsx_runtime_1.jsx)(antd_mobile_1.List.Item, { prefix: ele.avatar ? (0, jsx_runtime_1.jsx)(antd_mobile_1.Avatar, { className: mobile_module_less_1.default.avatar, src: ele.avatar }) : (0, jsx_runtime_1.jsx)(antd_mobile_icons_1.UserCircleOutline, { className: mobile_module_less_1.default.avatar }), extra: ele.mobile || '--', description: (0, jsx_runtime_1.jsx)("div", { style: {
                                ...
                                var _a, _b;
                                return ((0, jsx_runtime_1.jsx)(antd_mobile_1.Tag, { fill: "outline", children: ((_a = ele2.relation) === null || _a === void 0 ? void 0 : _a.name) ? t(entity + ':r.' + ele2.relation.name) : (_b = ele2.relation) === null || _b === void 0 ? void 0 : _b.display }, index));
