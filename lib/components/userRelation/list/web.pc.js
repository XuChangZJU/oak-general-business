...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: web_module_less_1.default.container, children: [(0, jsx_runtime_1.jsx)(antd_1.Space, { style: { marginBottom: 16 }, children: (0, jsx_runtime_1.jsx)(antd_1.Button, { type: "primary", onClick: function () { return goUpsert(); }, children: "\u6DFB\u52A0" }) }), (0, jsx_runtime_1.jsx)(antd_1.Table, { loading: oakLoading, rowKey: "id", columns: [
                            ...
                            },
                            {
                                ...
                                render: function (value, record, index) {
                                    var _a, _b;
                                    return ((0, jsx_runtime_1.jsxs)(antd_1.Space, { children: [(0, jsx_runtime_1.jsx)("a", { onClick: function (e) { return goUpdate(record.id); }, children: !!((_a = record.userRelation$user) === null || _a === void 0 ? void 0 : _a.length)
                                                    ? t('common::action.update')
                                                    : t('common::action.grant') }), !!((_b = record.userRelation$user) === null || _b === void 0 ? void 0 : _b.length) && ((0, jsx_runtime_1.jsx)("a", { style: {
                        ...
                        } })] }), (0, jsx_runtime_1.jsx)(antd_1.Modal, { title: t('common::areYouSure'), open: !!idRemove, onOk: function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
