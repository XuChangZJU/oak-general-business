...
var RadioColor = function (props) { return ((0, jsx_runtime_1.jsx)("div", { className: radioColor_module_less_1.default.panel, children: color_1.defaultColor.map(function (color, index) { return ((0, jsx_runtime_1.jsx)("div", { onClick: function () { return props === null || props === void 0 ? void 0 : props.onChange(color); }, className: radioColor_module_less_1.default.box, style: {
