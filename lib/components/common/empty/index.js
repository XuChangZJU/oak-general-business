...
var Empty = function (props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: (0, classnames_1.default)(index_module_less_1.default['oak-empty'], (_a = {},
            _a[index_module_less_1.default['oak-empty-normal']] = image === simpleEmptyImg,
            _a), className) }, restProps, { children: [(0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: index_module_less_1.default['oak-empty-image'], style: imageStyle }, { children: imageNode })), des && (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: index_module_less_1.default['oak-empty-description'] }, { children: des })), children && ((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: index_module_less_1.default['oak-empty-footer'] }, { children: children })))] })));
};
