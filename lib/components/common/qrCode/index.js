...
function QrCode(props) {
    var _a = props.filename, filename = _a === void 0 ? 'qrCode.png' : _a, expiresAt = props.expiresAt, tips = props.tips, onDownload = props.onDownload, onRefresh = props.onRefresh, _b = props.width, width = _b === void 0 ? 280 : _b, _c = props.height, height = _c === void 0 ? 280 : _c, url = props.url;
    var prefixCls = 'oak';
    var _d = tslib_1.__read((0, react_1.useState)(''), 2), qrCodeImage = _d[0], setQrCodeImage = _d[1];
    ...
    if (expiresAt) {
        ...
        if (diff > 0) {
            ...
            if (diff2 > 0) {
                V = ((0, jsx_runtime_1.jsxs)("span", tslib_1.__assign({ className: "".concat(prefixCls, "-qrCodeBox_caption") }, { children: ["\u8BE5\u4E8C\u7EF4\u78011\u5929\u5185(", (0, jsx_runtime_1.jsx)("span", { children: expiresAtStr }), "\u524D)\u6709\u6548\uFF0C\u5931\u6548\u8BF7\u5237\u65B0"] })));
            }
            else {
                V = ((0, jsx_runtime_1.jsx)("span", tslib_1.__assign({ className: "".concat(prefixCls, "-qrCodeBox_caption") }, { children: "\u8BE5\u4E8C\u7EF4\u7801\u5DF2\u5931\u6548\uFF0C\u8BF7\u5237\u65B0" })));
            }
        }
    }
