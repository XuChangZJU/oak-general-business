...
function ErrorPage(props) {
    ...
    var prefixCls = 'oak';
    return ((0, jsx_runtime_1.jsxs)("div", { className: "".concat(prefixCls, "-errorBox"), children: [props.icon || (info === null || info === void 0 ? void 0 : info.icon), (0, jsx_runtime_1.jsx)("div", { className: "".concat(prefixCls, "-errorBox__title"), children: props.title || (info === null || info === void 0 ? void 0 : info.title) }), (0, jsx_runtime_1.jsx)("div", { className: "".concat(prefixCls, "-errorBox__description"), children: props.desc || (info === null || info === void 0 ? void 0 : info.desc) }), props.children || ((0, jsx_runtime_1.jsx)(antd_1.Button, { type: "primary", onClick: function () {
                    navigate(-1);
                }, children: "\u8FD4\u56DE" }))] }));
}
