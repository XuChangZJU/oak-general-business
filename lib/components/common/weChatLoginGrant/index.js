...
function Grant(props) {
    var _a = props.id, id = _a === void 0 ? 'login_grant_container' : _a, appId = props.appId, scope = props.scope, redirectUri = props.redirectUri, state = props.state, _b = props.style, style = _b === void 0 ? {} : _b, className = props.className, _c = props.dev, dev = _c === void 0 ? process.env.NODE_ENV === 'development' : _c;
    var _d = tslib_1.__read((0, react_1.useState)(''), 2), code = _d[0], setCode = _d[1];
    ...
    if (dev) {
        ...
        V = ((0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: "".concat(prefixCls2, "_prod") }, { children: [(0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: "".concat(prefixCls2, "_prod_header") }, { children: [(0, jsx_runtime_1.jsx)("input", { maxLength: 6, value: code, className: "".concat(prefixCls2, "_prod_header_input"), onChange: function (e) {
                                setCode(e.target.value);
                            } }), (0, jsx_runtime_1.jsx)("button", tslib_1.__assign({ className: "".concat(prefixCls2, "_prod_header_btn"), onClick: function () {
                                var url = WeChatLoginUrl(redirectUri, appId, scope, state);
                                window.location.href = url;
                            } }, { children: "\u767B\u5F55" }))] })), (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: "".concat(prefixCls2, "_prod_bottom") }, { children: (0, jsx_runtime_1.jsx)("span", tslib_1.__assign({ className: "".concat(prefixCls2, "_prod_bottom_title") }, { children: "\u5FAE\u4FE1\u6388\u6743\u767B\u5F55" })) }))] })));
    }
