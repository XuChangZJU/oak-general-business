...
exports.default = (0, react_1.memo)(function (props) {
    ...
    var Component = isHeadingElement
        ? variant
        : 'span';
    return ((0, jsx_runtime_1.jsx)(Component, tslib_1.__assign({ style: style, onClick: !disabled ? onClick : undefined, className: (0, classnames_1.default)(className, index_module_less_1.default[prefixCls], (_a = {},
