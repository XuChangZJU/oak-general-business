...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: web_module_less_1.default.container, children: (0, jsx_runtime_1.jsx)(antd_1.Table, { loading: oakLoading, dataSource: messages || [], rowKey: "id", 
            // scroll={{ x: 1200 }}
            columns: [
                // {
                ...
                // },
                {
                    ...
                    render: function (value, record, index) {
                        if (record.visitState === 'unvisited') {
                            return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_1.Badge, { style: { marginRight: 5 }, status: "processing" }), (0, jsx_runtime_1.jsx)(antd_1.Typography.Link, { onClick: function () {
                                            goDetailById(record.id);
                                        }, children: value })] }));
                        }
                        return ((0, jsx_runtime_1.jsx)(antd_1.Typography.Text, { onClick: function () {
                                goDetailById(record.id);
                            }, children: value }));
                    },
                },
