...
const list_1 = tslib_1.__importDefault(require("../..//wechatPublicTag/list"));
...
function Render(props) {
    ...
    if (type === 'wechatPublic') {
        items.push({
            ...
            key: 'tag',
            children: ((0, jsx_runtime_1.jsx)(list_1.default, { oakAutoUnmount: true, applicationId: id, oakPath: `$application-panel-tag-${id}` }))
        }, {
