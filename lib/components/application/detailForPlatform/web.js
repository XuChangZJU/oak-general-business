...
function Render(props) {
    ...
    const [tabKey, setTabKey] = (0, react_1.useState)('menu');
    const Actions = [];
    const items = [
        {
            label: '公众号菜单管理',
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: web_module_less_1.default.container, children: (0, jsx_runtime_1.jsx)(antd_1.Card, { title: name, bordered: false, extra: Actions, children: (0, jsx_runtime_1.jsx)(antd_1.Tabs, { items: items, onChange: (key) => {
                    setTabKey(key);
                } }) }) }));
}
