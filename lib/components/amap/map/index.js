...
var memo = function (props) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: style, className: (0, classnames_1.default)("".concat(prefixCls, "-map"), className), children: (0, jsx_runtime_1.jsx)(react_amap_1.APILoader, { akey: akey, version: version, children: (0, jsx_runtime_1.jsx)(react_amap_1.Map, tslib_1.__assign({ ref: mapRef }, mapProps, { children: children })) }) }));
};
