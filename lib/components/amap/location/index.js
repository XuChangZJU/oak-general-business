...
var Location = function (props) {
    var visible = props.visible, header = props.header, akey = props.akey, _a = props.version, version = _a === void 0 ? '2.0' : _a, onClose = props.onClose, onConfirm = props.onConfirm, _b = props.geolocationProps, geolocationProps = _b === void 0 ? {} : _b, _c = props.useGeolocation, useGeolocation = _c === void 0 ? true : _c;
    var searchRef = (0, react_1.useRef)();
    var _d = tslib_1.__read((0, react_1.useState)(''), 2), searchValue = _d[0], setSearchValue = _d[1];
    var _e = tslib_1.__read((0, react_1.useState)(true), 2), refresh = _e[0], setRefresh = _e[1]; // 点击poi不触发setPositionPickerResult
    var _f = tslib_1.__read((0, react_1.useState)('dragMap'), 2), mode = _f[0], setMode = _f[1];
    var _g = tslib_1.__read((0, react_1.useState)(), 2), map = _g[0], setMap = _g[1];
    var _h = tslib_1.__read((0, react_1.useState)(), 2), positionPickerResult = _h[0], setPositionPickerResult = _h[1];
    var _j = tslib_1.__read((0, react_1.useState)(), 2), searchResult = _j[0], setSearchResult = _j[1];
    var _k = tslib_1.__read((0, react_1.useState)(), 2), pois = _k[0], setPois = _k[1];
    var _l = tslib_1.__read((0, react_1.useState)(), 2), currentPoi = _l[0], setCurrentPoi = _l[1];
    var _m = tslib_1.__read((0, react_1.useState)(), 2), oldPois = _m[0], setOldPois = _m[1];
    var _o = tslib_1.__read((0, react_1.useState)(), 2), oldPoi = _o[0], setOldPoi = _o[1];
    var _p = tslib_1.__read((0, react_1.useState)(false), 2), loadUI = _p[0], setLoadUI = _p[1];
    var _q = tslib_1.__read((0, react_1.useState)(false), 2), focus = _q[0], setFocus = _q[1];
    var _r = tslib_1.__read((0, react_1.useState)(false), 2), searchLoading = _r[0], setSearchLoading = _r[1];
    var _s = tslib_1.__read((0, react_1.useState)(false), 2), show = _s[0], setShow = _s[1];
    ...
    return ((0, jsx_runtime_1.jsx)(tdesign_react_1.Dialog, tslib_1.__assign({ header: header, width: "80%", visible: visible, onClose: function () {
            ...
            clearData();
                            ...
                            onDragStart: function () {
                                ...
                                } }), useGeolocation && ((0, jsx_runtime_1.jsx)(react_amap_1.Geolocation, tslib_1.__assign({ maximumAge: 100000, borderRadius: "5px", position: "RB", offset: [10, 10], zoomToAccuracy: true, showCircle: true }, geolocationProps, { onComplete: function (data) {
