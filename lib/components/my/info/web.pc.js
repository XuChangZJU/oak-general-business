...
function Render(props) {
    ...
    if (!userId) {
        return ((0, jsx_runtime_1.jsxs)("div", { className: web_pc_module_less_1.default.container, children: [(0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.header, children: (0, jsx_runtime_1.jsx)(antd_1.Button, { onClick: function () { return navigateTo({
                            url: '/login',
