...
function Render(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_1.Badge, { count: count, children: (0, jsx_runtime_1.jsx)(antd_1.Button, { className: (0, classnames_1.default)(web_module_less_1.default.btn, buttonClassName), style: buttonStyle, type: "text", shape: "circle", icon: (0, jsx_runtime_1.jsx)(icons_1.BellOutlined, { className: (0, classnames_1.default)(web_module_less_1.default.icon, className), style: style }), onClick: function (e) {
                        ...
                        setOpen(true);
                    } }) }), (0, jsx_runtime_1.jsx)(antd_1.Drawer, { title: "\u6D88\u606F", placement: "right", open: open, onClose: function () {
                    setOpen(false);
                }, extra: (0, jsx_runtime_1.jsx)(antd_1.Space, { children: (0, jsx_runtime_1.jsx)(antd_1.Button, { size: "small", type: "text", onClick: function () {
                            setOpen(false);
                            goMessageList();
