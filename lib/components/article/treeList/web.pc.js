...
function Render(props) {
    var _this = this;
    var _a = props.data, rows = _a.rows, oakFullpath = _a.oakFullpath, onChildEditArticleChange = _a.onChildEditArticleChange, show = _a.show, getBreadcrumbItemsByParent = _a.getBreadcrumbItemsByParent, breadcrumbItems = _a.breadcrumbItems, drawerOpen = _a.drawerOpen, changeDrawerOpen = _a.changeDrawerOpen, selectedArticleId = _a.selectedArticleId, openArray = _a.openArray, getTopInfo = _a.getTopInfo;
