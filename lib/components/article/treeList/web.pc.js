...
function Render(props) {
    ...
    if (oakFullpath) {
        if (!show) {
            ...
            if ((rows === null || rows === void 0 ? void 0 : rows.length) > 0) {
                return ((0, jsx_runtime_1.jsxs)("div", { children: [rows.map(function (ele, idx) { return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: web_pc_module_less_1.default.test, onClick: function () {
                                    onChildEditArticleChange(ele.id);
