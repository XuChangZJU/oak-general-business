...
function Render(props) {
    var _this = this;
    var _a = props.data, rows = _a.rows, oakFullpath = _a.oakFullpath, onChildEditArticleChange = _a.onChildEditArticleChange, show = _a.show, getBreadcrumbItemsByParent = _a.getBreadcrumbItemsByParent, breadcrumbItems = _a.breadcrumbItems, drawerOpen = _a.drawerOpen, changeDrawerOpen = _a.changeDrawerOpen, selectedArticleId = _a.selectedArticleId, openArray = _a.openArray, getTopInfo = _a.getTopInfo, articleId = _a.articleId, currentArticle = _a.currentArticle, setCurrentArticle = _a.setCurrentArticle;
    ...
    (0, react_1.useEffect)(function () {
        if (rows && rows.length > 0 && selectedArticleId) {
            var data = rows.find(function (ele) { return ele.id === selectedArticleId; });
            if (data) {
    ...
    if (oakFullpath) {
        if (!show) {
            if ((rows === null || rows === void 0 ? void 0 : rows.length) > 0) {
                return ((0, jsx_runtime_1.jsxs)("div", { children: [rows.map(function (ele, idx) { return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: web_pc_module_less_1.default.container, onClick: function () {
                                        onChildEditArticleChange(ele.id);
                                                        ...
                                                        }, style: { marginRight: 4 } }), (0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.name, children: (0, jsx_runtime_1.jsx)("div", { style: { marginLeft: 4, overflow: 'hidden', width: '150px', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }, children: ele === null || ele === void 0 ? void 0 : ele.name }) })] }) }), (0, jsx_runtime_1.jsx)(antd_1.Divider, { type: "vertical", style: { height: '100%', marginTop: 4, marginBottom: 4 } }), (0, jsx_runtime_1.jsxs)("div", { className: web_pc_module_less_1.default.control, children: [(0, jsx_runtime_1.jsx)(antd_1.Button, { type: "text", icon: (0, jsx_runtime_1.jsx)(icons_1.CopyOutlined, {}), size: "small", onClick: function (e) {
                                                        e.stopPropagation();
            ...
            if ((rows === null || rows === void 0 ? void 0 : rows.length) > 0) {
                return ((0, jsx_runtime_1.jsxs)("div", { children: [rows.map(function (ele, idx) { return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)("div", { className: web_pc_module_less_1.default.test, onClick: function () {
                                    onChildEditArticleChange(ele.id);
