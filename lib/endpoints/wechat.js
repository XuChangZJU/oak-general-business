        ...
        return tslib_1.__generator(this, function (_m) {
            switch (_m.label) {
                ...
                case 8:
                    ...
                    (0, assert_1.assert)(domain, "\u5904\u7406userEntityGrant\u65F6\uFF0C\u627E\u4E0D\u5230\u5BF9\u5E94\u7684domain\uFF0CapplicationId\u662F\u300C".concat(applicationId, "\u300D"));
                ...
                case 13:
                    ...
                    (0, assert_1.assert)(domain, "\u5904\u7406wechatLogin\u65F6\uFF0C\u627E\u4E0D\u5230\u5BF9\u5E94\u7684domain\uFF0CapplicationId\u662F\u300C".concat(applicationId, "\u300D"));
                    url = (0, domain_1.composeDomainUrl)(domain, 'wechatQrCode/scan', {
                        scene: sceneStr,
                        time: "".concat(Date.now()),
                    });
        ...
        },
        {
            ...
            fn: function (context, params, body, req, headers) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            searchParams = new url_1.default.URL("http://".concat(req.headers.host).concat(req.url)).searchParams;
                            appId = params.appId;
                            if (!appId || appId === '20230210') {
                                console.error('applicationId参数不存在');
