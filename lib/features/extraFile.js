...
var ExtraFile = /** @class */ (function (_super) {
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                url: (0, extraFile_1.composeFileUrl)(Object.assign({}, extraFile, { extra1: null }), config),
                                bucket: bucket,
                            }];
                }
            });
    ...
    ExtraFile.prototype.upload = function (extraFile, file) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var id, origin, _a, extraFileData, up, uploadInfo, err_1;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 5]);
                        uploadInfo = uploader_1.default[origin].upload(extraFileData, up.uploadFile, file);
