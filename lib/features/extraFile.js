...
var ExtraFile = /** @class */ (function (_super) {
    ...
    ExtraFile.prototype.upload = function (extraFile) {
        return __awaiter(this, void 0, void 0, function () {
            var origin_1, extra1, filename, objectId, extension, entity, fileName, uploadInfo, up, result, up, result, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        fileName = "".concat(entity, "/").concat(objectId, ".").concat(extension);
                        return [4 /*yield*/, this.getAspectWrapper().exec('getUploadInfo', {
                                origin: origin_1,
                                fileName: fileName,
                            })];
                    case 1:
