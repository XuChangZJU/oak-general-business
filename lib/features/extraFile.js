...
var ExtraFile = /** @class */ (function (_super) {
    ...
    ExtraFile.prototype.getUploadInfo = function (extraFile) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var origin, extra1, filename, objectId, extension, entity, key, uploadInfo;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.cache.exec('getUploadInfo', {
                                origin: origin,
                                key: key,
                            })];
                    case 1:
    ...
    ExtraFile.prototype.upload = function (extraFile) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var origin, extra1, filename, objectId, extension, entity, uploadInfo, up, result, up, result;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        origin = extraFile.origin, extra1 = extraFile.extra1, filename = extraFile.filename, objectId = extraFile.objectId, extension = extraFile.extension, entity = extraFile.entity, uploadInfo = extraFile.uploadInfo;
