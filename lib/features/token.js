...
var Token = /** @class */ (function (_super) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.aspectWrapper.exec('loginByMobile', { password: password, mobile: mobile, captcha: captcha, env: env })];
                    case 4:
                        result = (_a.sent()).result;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        env = _a.sent();
                        return [4 /*yield*/, this.aspectWrapper.exec('loginWechat', {
                                code: code,
                                env: env,
                            })];
                    case 4:
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        env = _a.sent();
                        return [4 /*yield*/, this.aspectWrapper.exec('loginWechatMp', {
                                code: code,
                                env: env,
                            })];
                    case 5:
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.aspectWrapper.exec('syncUserInfoWechatMp', {
                                nickname: nickname,
                                avatarUrl: avatarUrl,
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (token === null || token === void 0 ? void 0 : token.user) {
                            return [2 /*return*/, token.user];
                        }
                        if (!(token === null || token === void 0 ? void 0 : token.userId)) return [3 /*break*/, 3];
    ...
    Token.prototype.isRoot = function () {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var token, userRole$user;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getToken(true)];
                    case 1:
                        token = _b.sent();
                        userRole$user = (_a = token === null || token === void 0 ? void 0 : token.player) === null || _a === void 0 ? void 0 : _a.userRole$user;
                        return [2 /*return*/, ((userRole$user === null || userRole$user === void 0 ? void 0 : userRole$user.length) > 0 &&
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        env = _a.sent();
                        return [4 /*yield*/, this.aspectWrapper.exec('sendCaptcha', {
                                mobile: mobile,
                                env: env,
                            })];
                    case 2:
