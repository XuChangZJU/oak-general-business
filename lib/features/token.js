...
var Token = /** @class */ (function (_super) {
    ...
    Token.prototype.isRoot = function (context) {
        var _a;
        var token = this.getToken(true, context);
        var userRelation$user = (_a = token === null || token === void 0 ? void 0 : token.user) === null || _a === void 0 ? void 0 : _a.userRelation$user;
        return !!(userRelation$user &&
            (userRelation$user === null || userRelation$user === void 0 ? void 0 : userRelation$user.length) > 0);
    };
    /**
    ...
    Token.prototype.isReallyRoot = function (context) {
        var _a;
        var token = this.getToken(true, context);
        var userRelation$user = (_a = token === null || token === void 0 ? void 0 : token.player) === null || _a === void 0 ? void 0 : _a.userRelation$user;
        return !!(userRelation$user &&
            (userRelation$user === null || userRelation$user === void 0 ? void 0 : userRelation$user.length) > 0);
    };
