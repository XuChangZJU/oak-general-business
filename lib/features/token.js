...
var Token = /** @class */ (function (_super) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        env = _a.sent();
                        return [4 /*yield*/, this.cache.exec('loginByMobile', { password: password, mobile: mobile, captcha: captcha, env: env })];
                    case 2:
                        result = _a.sent();
    ...
    Token.prototype.getUserId = function (allowUnloggedIn) {
        if (this.tokenValue) {
            var _a = tslib_1.__read(this.cache.get('token', {
                data: {
                    id: 1,
                    userId: 1,
                },
    ...
    Token.prototype.isRoot = function () {
        ...
        return !!(userRole$user && (userRole$user === null || userRole$user === void 0 ? void 0 : userRole$user.length) > 0 && userRole$user.find(function (ele) { return ele.roleId === constants_1.ROOT_ROLE_ID; }));
    };
