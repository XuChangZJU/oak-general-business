...
var Token = /** @class */ (function (_super) {
    ...
    Token.prototype.getToken = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getTokenValue()];
                    case 1:
                        token = _a.sent();
                        if (!token) {
                            return [2 /*return*/];
    ...
    Token.prototype.isRoot = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var tokenValue, _a, tokens, player, userRole$user;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getTokenValue()];
                    case 1:
                    ...
                    case 2:
                        _a = tslib_1.__read.apply(void 0, [(_b.sent()), 1]), tokens = _a[0];
                        player = tokens.player;
                        userRole$user = player.userRole$user;
                        return [2 /*return*/, userRole$user.length > 0 && userRole$user.find(function (ele) { return ele.role.name === 'root'; })];
                }
            });
        });
    };
