...
export declare type CreateOperationData = FormCreateData<Omit<OpSchema, "parentId" | "parent"> & ({
...
export declare type UpdateOperationData = FormUpdateData<Omit<OpSchema, "parentId" | "parent">> & ({
