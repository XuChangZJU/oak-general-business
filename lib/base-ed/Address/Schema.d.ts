...
export declare type CreateOperationData = FormCreateData<Omit<OpSchema, "areaId" | "area"> & ({
...
export declare type UpdateOperationData = FormUpdateData<Omit<OpSchema, "areaId" | "area">> & ({
