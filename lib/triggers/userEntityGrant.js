...
var triggers = [
    ...
    },
    {
        ...
        fn: function (_a, context) {
            ...
            return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var _loop_1, result_1, result_1_1, userEntityGrant, e_1_1;
                var e_1, _b;
                var _c, _d, _e;
                return tslib_1.__generator(this, function (_f) {
                    switch (_f.label) {
                        case 0:
                            ...
                            _loop_1 = function (userEntityGrant) {
                                var wechatQrCode, id_1, backContext, buffer_1;
                                return tslib_1.__generator(this, function (_g) {
                                    switch (_g.label) {
                                        case 0:
                                            if (!(userEntityGrant.qrCodeType === 'wechatMpWxaCode')) return [3 /*break*/, 2];
                                            wechatQrCode = userEntityGrant.wechatQrCode$entity &&
                                                userEntityGrant.wechatQrCode$entity[0];
                                            if (!wechatQrCode) return [3 /*break*/, 2];
                                            id_1 = wechatQrCode.id;
                                            backContext = context;
                                            return [4 /*yield*/, (0, wechatQrCode_1.getMpUnlimitWxaCode)(wechatQrCode.id, backContext)];
                                        case 1:
                                            buffer_1 = _g.sent();
                                            backContext.opRecords.forEach(function (ele) {
                                                if (ele.a === 's') {
                                                    var d = ele.d;
                                                    if (d.wechatQrCode && d.wechatQrCode[id_1]) {
                                                        Object.assign(d.wechatQrCode[id_1], {
                                                            buffer: buffer_1,
                                                        });
                                                    }
                                                }
                        ...
                        case 2:
                            ...
                            return [5 /*yield**/, _loop_1(userEntityGrant)];
                        case 3:
                            _f.sent();
                            _f.label = 4;
                        case 4:
