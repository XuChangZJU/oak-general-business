...
var triggers = [
    ...
    },
    {
        ...
        fn: function (_a, context, params) {
            var operation = _a.operation;
            return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var data, filter, userId, result, _b, entity, entityId, relation, entityStr, userRelation, result2, _c, _d, _e;
                var _f, _g, _h, _j;
                return tslib_1.__generator(this, function (_k) {
                    switch (_k.label) {
                        ...
                        case 5: return [4 /*yield*/, _d.apply(_c, _e.concat([(_h.id = _k.sent(),
                                    _h.action = 'create',
                                    _h.data = (_j = {
                                            userId: userId
                                        },
