...
var triggers = [
    ...
    },
    {
        ...
        fn: function (_a, context, params) {
            var operation = _a.operation;
            return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var data, filter, userId, closeRootMode, result, _b, number, confirmed;
    ...
    },
    {
        ...
        fn: function (_a, context, option) {
            var operation = _a.operation;
            return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var data, filter, userId, closeRootMode, _b, userEntityGrant, entity, entityId, relationId, granterId, type, result2, e, _c, _d, _e, _f, _g, _h, err_1;
                var _j, _k, _l;
                return tslib_1.__generator(this, function (_m) {
                    switch (_m.label) {
                        ...
                        case 1:
                            _b = tslib_1.__read.apply(void 0, [_m.sent(), 1]), userEntityGrant = _b[0];
                        ...
                        case 4:
                            ...
                            _k = {};
                            return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                        case 5: return [4 /*yield*/, _d.apply(_c, _e.concat([(_j.data = (_k.id = _m.sent(),
                                    _k.userId = userId,
                                    _k.relationId = relationId,
                                    _k.entity = entity,
                        ...
                        case 6:
                            ...
                            _l = {};
                            return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                        case 7: return [4 /*yield*/, _g.apply(_f, _h.concat([(_l.id = _m.sent(),
                                    _l.action = 'remove',
                                    _l.data = {},
                                    _l.filter = {
                                        relationId: relationId,
