...
var triggers = [
    {
        ...
        fn: function (_a, context) {
            ...
            return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var data, closeRootMode, data_1, data_1_1, d, e_2_1, err_4;
                var e_2, _b;
                return tslib_1.__generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 10: return [4 /*yield*/, sendNotification(data, context)];
                        case 11:
                            _c.sent();
                            _c.label = 12;
    ...
    },
    {
        ...
        fn: function (_a, context) {
            var operation = _a.operation;
            return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var filter, closeRootMode, messages, _b, message, success, allFailed, smsTried, _c, _d, ms, _e, _f, n, _g, _h, _j, result, _k, _l, _m, err_5;
                ...
                return tslib_1.__generator(this, function (_s) {
                    switch (_s.label) {
                        ...
                        case 4:
                            ...
                            return [2 /*return*/, 1];
                        case 5:
                            if (!(message.weight === 'medium' && !smsTried && allFailed)) return [3 /*break*/, 7];
                        ...
                        case 7:
                            if (!allFailed) return [3 /*break*/, 10];
                            _l = (_k = context).operate;
                            _m = ['message'];
                            _r = {};
                            return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                        case 8: return [4 /*yield*/, _l.apply(_k, _m.concat([(_r.id = _s.sent(),
                                    _r.action = 'fail',
                                    _r.data = {},
                                    _r.filter = {
                                        id: message.id,
