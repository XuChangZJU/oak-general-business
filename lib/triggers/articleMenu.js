...
var triggers = [
    ...
    },
    {
        ...
        when: 'before',
        fn: function (event, context) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a, data, filter, _b, articleMenu, articleMenus, _c, _d, _e;
            var _f;
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                    ...
                    case 2:
                        articleMenus = _g.sent();
                        if (!(articleMenus.length === 0)) return [3 /*break*/, 5];
                        _d = (_c = context).operate;
                        _e = ['articleMenu'];
                        _f = {};
                        return [4 /*yield*/, (0, uuid_1.generateNewIdAsync)()];
                    case 3: return [4 /*yield*/, _d.apply(_c, _e.concat([(_f.id = _g.sent(),
                                _f.action = 'update',
                                _f.data = {
                                    isLeaf: false,
                                },
