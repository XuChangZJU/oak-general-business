...
exports.createComponent = exports.subscribeMessage = void 0;
 ...
 * @returns
 */
function subscribeMessage(messageTypes, haveToAccept) {
...
function createComponent(option, features) {
    ...
    return (0, page_mp_1.createComponent)(tslib_1.__assign({ methods: tslib_1.__assign({ subscribeMessage: function (messageTypes, haveToAccept) {
                return tslib_1.__awaiter(this, void 0, void 0, function () {
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, subscribeMessage.call(this, messageTypes, haveToAccept)];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
