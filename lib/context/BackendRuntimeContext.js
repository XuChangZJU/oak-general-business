...
var BackendRuntimeContext = /** @class */ (function (_super) {
    ...
    BackendRuntimeContext.prototype.refineOpRecords = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, _b, opRecord, d, _c, _d, _e, _i, entity, wechatQrCodeListObj, _f, _g, _h, _j, id, wechatQrCodeData, buffer, e_1_1;
            var e_1, _k;
            return tslib_1.__generator(this, function (_l) {
                switch (_l.label) {
                    case 0:
                        _l.trys.push([0, 11, 12, 13]);
                    ...
                    case 2:
                        ...
                        _l.label = 3;
                    case 3:
                        if (!(_j < _g.length)) return [3 /*break*/, 6];
                        _h = _g[_j];
                        if (!(_h in _f)) return [3 /*break*/, 5];
                        id = _h;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.amIRoot = user === null || user === void 0 ? void 0 : user.isRoot;
                        this.amIReallyRoot = player === null || player === void 0 ? void 0 : player.isRoot;
                        this.token = token;
                        return [2 /*return*/];
                }
            });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        (0, assert_1.assert)(result.length > 0, "\u6784\u5EFABackendRuntimeContext\u5BF9\u5E94appId\u300C".concat(appId, "\u300D\u627E\u4E0D\u5230application"));
    ...
    BackendRuntimeContext.prototype.initialize = function (data) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var closeRootMode, appId, tokenValue, promises, err_1;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        closeRootMode = this.openRootMode();
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 6, , 8]);
    ...
    BackendRuntimeContext.prototype.openRootMode = function () {
        var _this = this;
        if (this.rootMode) {
            return function () { return undefined; };
        }
        this.rootMode = true;
        return function () { return (_this.rootMode = false); };
    };
