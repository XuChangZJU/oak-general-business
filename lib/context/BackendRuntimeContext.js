...
var BackendRuntimeContext = /** @class */ (function (_super) {
    ...
    BackendRuntimeContext.prototype.setTokenValue = function (tokenValue) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var result, token, user, player, userRelation$user, userRelation$player;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        userRelation$user = user.userRelation$user;
                        this.amIRoot = userRelation$user.length > 0;
                        userRelation$player = player.userRelation$user;
                        this.amIReallyRoot = userRelation$player.length > 0;
                        this.token = token;
                        return [2 /*return*/];
                }
            });
    ...
    BackendRuntimeContext.prototype.setRootMode = function (mode) {
        this.rootMode = mode;
    };
