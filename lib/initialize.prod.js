...
function initialize(type, domain, storageSchema, frontendContextBuilder, connector, checkers, actionDict, authDict, relationDict) {
    ...
    var features = (0, initialize_prod_1.initialize)(storageSchema, frontendContextBuilder, connector, checkers2, actionDict2, authDict2, relationDict).features;
