...
function initialize(type, domain, storageSchema, frontendContextBuilder, connector, checkers, option) {
    ...
    if (option.actionDict) {
        intersected = (0, lodash_1.intersection)(Object.keys(general_app_domain_1.ActionDefDict), Object.keys(option.actionDict));
    ...
    option.actionDict = Object.assign({}, general_app_domain_1.ActionDefDict, option.actionDict);
    var features = (0, initialize_prod_1.initialize)(storageSchema, frontendContextBuilder, connector, checkers2, option).features;
    // 临时代码
