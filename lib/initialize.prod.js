...
function initialize(type, domain, storageSchema, frontendContextBuilder, connector, checkers, actionDict, authDict, relationDict, colorDict) {
    ...
    var features = (0, initialize_prod_1.initialize)(storageSchema, frontendContextBuilder, connector, checkers2, actionDict2, authDict2, relationDict, colorDict).features;
