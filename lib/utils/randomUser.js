...
exports.getName = exports.randomName = void 0;
/**
 *
 ...
 * @returns
 */
function randomName(prefix, randomLength) {
    // 兼容更低版本的默认值写法
    ...
    for (var i = 0; i < randomLength; i++) {
        ...
        var zm = nameArr[index][Math.floor(Math.random() * nameArr[index].length)];
        // 如果随机出的是英文字母
        if (index === 1) {
            // 则百分之50的概率变为大写
...
1;
function getName(name, start, end) {
