...
declare type AttrFilter = {
    ...
    oper$operator: Oper.Filter;
    user$ref: Filter;
    userRelation$user: UserRelation.Filter;
    email$user: Email.Filter;
    message$user: Message.Filter;
    mobile$user: Mobile.Filter;
    token$user: Token.Filter;
    token$player: Token.Filter;
    userEntityGrant$granter: UserEntityGrant.Filter;
    userEntityGrant$grantee: UserEntityGrant.Filter;
    userSystem$user: UserSystem.Filter;
    userWechatPublicTag$user: UserWechatPublicTag.Filter;
    wechatLogin$user: WechatLogin.Filter;
    wechatUser$user: WechatUser.Filter;
    modiEntity$entity: ModiEntity.Filter;
    operEntity$entity: OperEntity.Filter;
    extraFile$entity: ExtraFile.Filter;
    wechatQrCode$entity: WechatQrCode.Filter;
};
