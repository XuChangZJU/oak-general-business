import { String, Int, Boolean, Datetime, ForeignKey } from "oak-domain/lib/types/DataType";
...
declare type AttrFilter = {
    id: Q_StringValue | SubQuery.ParasiteIdSubQuery;
    ...
    redirectTo: Q_EnumValue<RedirectTo>;
